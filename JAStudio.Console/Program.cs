...
try
{
    // Configure Python runtime to find your base Python + venv packages
    var pythonHome = @"C:\Users\magnu\AppData\Local\Programs\Python\Python313";
    var pythonDll = Path.Combine(pythonHome, "python313.dll");
    var venvSitePackages = @"C:\Users\magnu\PycharmProjects\MagnusAnkiAddon\venv\Lib\site-packages";
    ...
    {
        Console.WriteLine("Warning: Could not find Python DLL.");
        Console.WriteLine("Expected location: " + pythonDll);
    }

    // Initialize Python runtime
    PythonEngine.Initialize();
    
    // Add venv site-packages for janome
    using (Py.GIL())
    {
