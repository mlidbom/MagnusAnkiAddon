...
@pytest.mark.parametrize('sentence, excluded, expected', [
    ...
    ("今じゃ町は夜でも明るいしもう会うこともないかもな", {"しもう"}, [N('今じゃ', '', [N('今', ''), N('じゃ', '')]), N('町は', '', [N('町', ''), N('は', '')]), N('夜でも', '', [N('夜', ''), N('でも', '')]), N('明るいし', '', [N('明るい', ''), N('し', '')]), N('もう', ''), N('会うこともないかも', '', [N('会う', ''), N('こと', ''), N('も', ''), N('ない', ''), N('かも', '')]), N('な', '')])
])
...
@pytest.mark.parametrize('sentence, excluded, expected', [
    ...
    ("言えばよかった", set(), [N('言えば', '', [N('言う', '言え'), N('ば', '')]), N('よかった', '', [N('よい', 'よかっ'), N('た', '')])])
])
...
@pytest.mark.parametrize('sentence, excluded, expected', [
    ("あいつが話の中に出てくるのが", set(), [N('あいつが', '', [N('あいつ', ''), N('が', '')]), N('話の中に', '', [N('話', ''), N('の', ''), N('中', ''), N('に', '')]), N('出てくるのが', '', [N('出てくるの', '', [N('出てくる', '', [N('出る', '出'), N('て', ''), N('くる', '')]), N('の', '')]), N('が', '')])]),
...
@pytest.mark.parametrize('sentence, excluded, expected', [
    # TODO: RESTORE! ("友達だから　余計に気になっちゃうんだよ", set(), [N('友達だから','',[N('友達',''), N('だから','',[N('だ',''), N('から','')])]), N('余計',''), N('に',''), N('気になっちゃうんだよ','',[N('気になる','気になっ',[N('気',''), N('に',''), N('なる','なっ')]), N('ちゃう',''), N('んだ','',[N('ん',''), N('だ','')]), N('よ','')])])
    # TODO: RESTORE! ("知ってもらえてない人に", set(), [N('知ってもらえてない人に', '', [N('知る', '知っ'), N('て', ''), N('もらう', 'もらえ'), N('てる', 'て'), N('ない', ''), N('人', ''), N('に', '')])])
    ("出てくるのが", set(),
     [N('出てくるのが', '',
        [N('出てくるの', '',
           [N('出てくる', '', [N('出る', '出'), N('て', ''), N('くる', '')]), N('の', '')]), N('が', '')])]
     ),
])
