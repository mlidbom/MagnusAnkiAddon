...
@pytest.mark.parametrize('sentence, excluded, expected', [
    ...
    ("ついに素晴らしい女性に逢えた。", {"逢える", "えた"}, [Node('ついに', ''), Node('素晴らしい', ''), Node('女性に', '', [Node('女性', ''), Node('に', '')]), Node('逢', ''), Node('え', ''), Node('た', '')]),
    ("ううん藤宮さんは日記を捨てるような人じゃない", set(), [Node('ううん',''), Node('藤宮',''), Node('さん',''), Node('は',''), Node('日記を','',[Node('日記',''), Node('を','')]), Node('捨てる',''), Node('ようだ','ような',[Node('よう',''), Node('だ','な')]), Node('人じゃない','',[Node('人',''), Node('じゃない','',[Node('じゃ',''), Node('ない','')])])]),
    ...
    ("離れていくよ", {"いくよ"}, [Node('離れていくよ','',[Node('離れる','離れ'), Node('て',''), Node('いく',''), Node('よ','')])]),
    ...
    ("食べてもいいけど", set(), [Node('食べてもいいけど','',[Node('食べる','食べ'), Node('てもいいけど','',[Node('てもいい','',[Node('ても','',[Node('て',''), Node('も','')]), Node('いい','')]), Node('けど','')])])]),
    ...
    ("明るいしもう", {"しもう", "しも"}, [Node('明るいする','明るいし',[Node('明るい',''), Node('する','し')]), Node('もう','',[Node('も',''), Node('う','')])]),
    ("今じゃ町は夜でも明るいしもう会うこともないかもな", {"しもう"}, [Node('今じゃ町は','',[Node('今',''), Node('じゃ',''), Node('町',''), Node('は','')]), Node('夜でも明るいし','',[Node('夜',''), Node('でも',''), Node('明るいし','',[Node('明るい',''), Node('し','')])]), Node('もう',''), Node('会うこともないかもな','',[Node('会う',''), Node('こと',''), Node('も',''), Node('ない',''), Node('かも',''), Node('な','')])])
])
