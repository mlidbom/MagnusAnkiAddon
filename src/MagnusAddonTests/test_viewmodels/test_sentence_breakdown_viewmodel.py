...
@pytest.mark.parametrize('sentence', [
    sentence_spec.test_sentence_list[0].question,
    sentence_spec.test_sentence_list[1].question,
    sentence_spec.test_sentence_list[2].question,
    sentence_spec.test_sentence_list[3].question,
    sentence_spec.test_sentence_list[4].question
])
