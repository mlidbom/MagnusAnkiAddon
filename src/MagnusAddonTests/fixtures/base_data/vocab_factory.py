...
def create_vocab() -> NoteTypeEx:
    return NoteTypeEx(NoteTypes.Vocab,
                      [NoteFieldEx(NoteFields.Vocab.question),
                       ...
                       NoteFieldEx(NoteFields.Vocab.Context_sentence_2_english),
                       NoteFieldEx(NoteFields.Vocab.Context_sentence_3_japanese),
                       NoteFieldEx(NoteFields.Vocab.Context_sentence_3_english),
