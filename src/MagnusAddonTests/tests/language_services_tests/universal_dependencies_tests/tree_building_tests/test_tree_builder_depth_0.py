...
@pytest.mark.parametrize('sentence, expected', [
    ...
    ("食べてもいいけど", R(N('食べて', '', ''),N('も', '', ''),N('いい', '', '良い'),N('けど', '', 'けれど'))),
    ...
    ("聞かなかったことにしてあげる", R(N('聞かなかったこと', '', ''),N('に', '', ''),N('し', 'する', '為る'),N('て', '', ''),N('あげる', '', '上げる'))),
    #todo volitional form..
    ("とりあえず　ご飯食べよう", R(N('とりあえず', '', '取り敢えず'),N('ご飯食べよう', '', ''))),
    #todo いいよう
    ("先生にいいように言って", R(N('先生に', '', ''),N('いいように言って', '', ''))),
    #todo: かっこいい
    ("意外とかっこいいな", R(N('意外と', '', ''),N('かっこいいな', '', ''))),
...
@pytest.mark.parametrize('sentence, parser, expected', [
    ...
    ("あいつが話の中に出てくるのが", ud_parsers.gendai, R(N('あいつが', '', ''),N('話の中に', '', ''),N('出てくるのが', '', ''))),
