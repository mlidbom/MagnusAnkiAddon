...
def test_sentences_we_are_satisfied_with(sentence: str, expected: R) -> None:
    run_tests(expected, None, sentence)

@pytest.mark.parametrize('sentence, expected', [
    ("今じゃ町は夜でも明るいしもう会うこともないかもな", R(N('今じゃ', '', '', [N('今', '', ''), N('じゃ', 'で', '')]), N('町は', '', '', [N('町', '', ''), N('は', '', '')]), N('夜でも', '', '', [N('夜', '', ''), N('でも', '', '', [N('で', '', ''), N('も', '', '')])]), N('明るいし', '', '', [N('明るい', '', ''), N('し', '', '')]), N('もう', '', ''), N('会う', '', ''), N('ことも', '', '', [N('こと', '事', ''), N('も', '', '')]), N('ないかも', '', '', [N('ない', '無い', ''), N('かも', '', '', [N('か', '', ''), N('も', '', '')])]), N('な', '', ''))),
    ("食べてもいいけど", R(N('食べても', '', '', [N('食べ', '食べる', ''), N('ても', '', '', [N('て', '', ''), N('も', '', '')])]), N('いいけど', '', '', [N('いい', '良い', ''), N('けど', 'けれど', '')]))),
    ...
    ("ごめん　自分から誘っといて ちゃんと調べておけばよかった", R(N('ごめん', '', '御免'), N('自分から', '', '', [N('自分', '', ''), N('から', '', '')]), N('誘っといて', '', '', [N('誘っ', '誘う', ''), N('とい', 'とく', ''), N('て', '', '')]), N('ちゃんと', '', ''), N('調べておけば', '', '', [N('調べ', '調べる', ''), N('ておけ', '', '', [N('て', '', ''), N('おけ', 'おく', '')]), N('ば', '', '')]), N('よかった', '', '', [N('よかっ', 'よい', '良い'), N('た', '', '')]))),
    ...
    ("なんというか 事情を分ってくれる人は少しでも多い方がいいと思うんだ", R()),
    ("そんなに気になるなら あの時俺も友達だって言えばよかったじゃん", R()),
    ("俺以外に友達がいなくてよかったとか　絶対思っちゃダメなのに", R()),
    ...
    ("探しているんですか", R(N('探しているんです', '', '', [N('探し', '探す', ''), N('ている', '', '', [N('て', '', ''), N('いる', '', '居る')]), N('んです', '', '', [N('ん', '', 'の'), N('です', '', '')])]), N('か', '', ''))),
    ("ダメダメ私を助けて", R(N('ダメダメ', '', ''), N('私を', '', '', [N('私', '', ''), N('を', '', '')]), N('助けて', '', '', [N('助け', '助ける', ''), N('て', '', '')]))),
    ("知らない", R(N('知らない', '', '', [N('知ら', '知る', ''), N('ない', '', '')]))),
    ("いつまでも来ないと知らないからね", R(N('いつまでも', '', '', [N('いつ', '', ''), N('までも', '', '', [N('まで', '', ''), N('も', '', '')])]), N('来ないと', '', '', [N('来', '来る', ''), N('ない', '', ''), N('と', '', '')]), N('知らないから', '', '', [N('知らない', '', '', [N('知ら', '知る', ''), N('ない', '', '')]), N('から', '', '')]), N('ね', '', ''))),
    ...
    ("当てられても", R(N('当てられても', '', '', [N('当てられ', '', '', [N('当て', '当てる', ''), N('られ', 'られる', '')]), N('ても', '', '', [N('て', '', ''), N('も', '', '')])]))),
    ...
    ("だろう", R(N('だろう', '', ''))),
    ("ううん藤宮さんは日記を捨てるような人じゃない", R(N('ううん', '', ''), N('藤宮さんは', '', '', [N('藤宮さん', '', '', [N('藤宮', 'フジミヤ', ''), N('さん', '', '')]), N('は', '', '')]), N('日記を', '', '', [N('日記', '', ''), N('を', '', '')]), N('捨てるような', '', '', [N('捨てる', '', ''), N('ような', '', '', [N('よう', '様', ''), N('な', '', '')])]), N('人じゃない', '', '', [N('人', '', ''), N('じゃ', 'だ', ''), N('ない', '無い', '')]))),
    ("としたら", R(N('と', '', ''), N('したら', '', '', [N('し', '為る', ''), N('たら', '', '')]))),
    ("あいつが話の中に出てくるのが", R(N('あいつが', '', '', [N('あいつ', '彼奴', ''), N('が', '', '')]), N('話の', '', '', [N('話', '', ''), N('の', '', '')]), N('中に', '', '', [N('中', '', ''), N('に', '', '')]), N('出てくるのが', '', '', [N('出', '出る', ''), N('てくるのが', '', '', [N('て', '', ''), N('くる', '来る', ''), N('の', '', ''), N('が', '', '')])]))),

], ids=only_string_params)
def test_display_sentences(sentence: str, expected: R) -> None: display_result(expected, None, sentence)
...
def run_tests(expected: R, parser: UDTokenizer | None, sentence: str) -> None:
    # test_display_interesting_sentences_we_should_add_real_tests_for(sentence)
    # return

    print()
    parser = parser if parser else ud_parsers.gendai
    real_result = ud_tree_builder.build_tree(parser, sentence, BottomUpdCompoundBuilder.create)
...
def display_result(expected: R, parser: UDTokenizer | None, sentence: str) -> None:
    # test_display_interesting_sentences_we_should_add_real_tests_for(sentence)
    # return
