...
@pytest.mark.parametrize('sentence, expected', [
    ...
    ("聞かなかったことにしてあげる", R(N('聞かなかったことにして', '', '', [N('聞か', '聞く', ''), N('なかったことにし', '', '', [N('なかっ', 'ない', ''), N('た', '', ''), N('ことにし', '', '', [N('こと', '', ''), N('に', '', ''), N('し', 'する', '為る')])]), N('て', '', '')]),N('あげる', '', '上げる'))),
...
@pytest.mark.parametrize('sentence, expected', [
    ...
    ("一度聞いたことがある", R(N('一度', '', ''),N('聞いたことがある', '', '', [N('聞い', '聞く', ''), N('た', '', ''), N('ことがある', '', '', [N('こと', '', ''), N('が', '', ''), N('ある', '', '有る')])]))),
...
@pytest.mark.parametrize('sentence, parser, expected', [
    ("ううん藤宮さんは日記を捨てるような人じゃない", ud_parsers.gendai, R(N('ううん', '', ''),N('藤宮さんは', '', '', [N('藤宮', 'フジミヤ', ''), N('さんは', '', '', [N('さん', '', ''), N('は', '', '')])]),N('日記を', '', '', [N('日記', '', ''), N('を', '', '')]),N('捨てるような', '', '', [N('捨てる', '', ''), N('ような', '', '', [N('よう', '様', ''), N('な', '', '')])]),N('人じゃない', '', '', [N('人', '', ''), N('じゃ', 'だ', ''), N('ない', '無い', '')]))),
