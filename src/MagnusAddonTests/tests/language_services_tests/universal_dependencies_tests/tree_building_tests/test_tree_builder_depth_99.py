...
@pytest.mark.parametrize('sentence, expected', [
    ...
    ("食べてもいいけど", R(N('食べてもいいけど', '', '', [N('食べ', '食べる', ''), N('てもいい', '', '', [N('て', '', ''), N('も', '', ''), N('いい', '', '良い')]), N('けど', '', 'けれど')]))),
...
@pytest.mark.parametrize('sentence, expected', [
    ...
    ("友達だから余計に気になっちゃうんだよ", R(N('友達だから', '', '', [N('友達', '', ''), N('だ', '', ''), N('から', '', '')]),N('余計に', '', '', [N('余計', '', ''), N('に', '', '')]),N('気に', '', '', [N('気', '', ''), N('に', '', '')]),N('なっちゃうんだ', '', '', [N('なっ', 'なる', '成る'), N('ちゃう', '', ''), N('んだ', '', '', [N('ん', '', 'の'), N('だ', '', '')])]),N('よ', '', ''))),
