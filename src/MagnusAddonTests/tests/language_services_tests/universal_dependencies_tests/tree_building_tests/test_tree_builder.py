...
@pytest.mark.parametrize('sentence, expected', [
    ...
    ("友達だから余計に気になっちゃうんだよ", R(N('友達だから余計に気になっちゃうん', '', '', [N('友達だから', '', '', [N('友達', '', ''), N('だ', '', ''), N('から', '', '')]), N('余計に', '余計だ', '', [N('余計', '', ''), N('に', 'だ', '')]), N('気になっちゃうん', '', '', [N('気に', '', '', [N('気', '', ''), N('に', '', '')]), N('なっちゃうん', '', '', [N('なっ', '成る', ''), N('ちゃう', '', ''), N('ん', '', 'の')])])]),N('だよ', '', '', [N('だ', '', ''), N('よ', '', '')]))),
    ...
    ("だったら", R(N('だったら', 'だった', '', [N('だっ', 'だ', ''), N('たら', 'た', '')])))
