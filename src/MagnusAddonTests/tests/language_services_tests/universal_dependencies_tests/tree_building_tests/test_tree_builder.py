...
@pytest.mark.parametrize('sentence, expected', [
    ...
    #todo No に->だ lemma mapping please.
    ("ように言ったのも", R(N('ように', '', '', [N('よう', '', ''), N('に', 'だ', '')]),N('言ったのも', '', '', [N('言っ', '言う', ''), N('た', '', ''), N('の', '', ''), N('も', '', '')]))),
    ("一度聞いたことがある", R(N('一度聞いたこと', '', '', [N('一度', '', ''), N('聞いたこと', '', '', [N('聞い', '聞く', ''), N('た', '', ''), N('こと', '', '')])]),N('がある', '', '', [N('が', '', ''), N('ある', '', '有る')]))),
    ("友達だから余計に気になっちゃうんだよ", R(N('友達だから余計に気になっちゃうん', '', '', [N('友達だから', '', '', [N('友達', '', ''), N('だ', '', ''), N('から', '', '')]), N('余計に', '', '', [N('余計', '', ''), N('に', 'だ', '')]), N('気になっちゃうん', '', '', [N('気に', '', '', [N('気', '', ''), N('に', '', '')]), N('なっちゃうん', '', '', [N('なっ', 'なる', '成る'), N('ちゃう', '', ''), N('ん', '', 'の')])])]),N('だよ', '', '', [N('だ', '', ''), N('よ', '', '')]))),
    ...
    ("良かったら", R(N('良かったら', '', '', [N('良かっ', '良い', ''), N('たら', '', 'た')]))),
...
@pytest.mark.parametrize('sentence, parser, expected', [
    ("ううん藤宮さんは日記を捨てるような人じゃない", ud_parsers.gendai, R(N('ううん藤宮さんは', '', '', [N('ううん', '', ''), N('藤宮さんは', '', '', [N('藤宮', 'フジミヤ', ''), N('さんは', '', '', [N('さん', '', ''), N('は', '', '')])])]),N('日記を捨てるような', '', '', [N('日記を', '', '', [N('日記', '', ''), N('を', '', '')]), N('捨てるような', '', '', [N('捨てる', '', ''), N('よう', '様', ''), N('な', 'だ', '')])]),N('人じゃない', '', '', [N('人', '', ''), N('じゃ', 'だ', ''), N('ない', '無い', '')]))),
    ("としたら", ud_parsers.gendai, R(N('としたら', '', '', [N('と', '', ''), N('したら', '', '', [N('し', '為る', ''), N('たら', '', 'た')])]))),
