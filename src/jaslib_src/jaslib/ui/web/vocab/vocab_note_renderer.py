...
def create_renderer(schedule_task: Callable[[Callable[[], str]], Future[str]]) -> PreRenderingContentRenderer[VocabNote]:
    """Factory method for VocabNote renderer with all tag mappings."""
    from jaslib.ui.web.pre_rendering_content_renderer import PreRenderingContentRenderer
