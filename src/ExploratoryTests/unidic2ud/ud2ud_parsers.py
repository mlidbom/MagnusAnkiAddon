...
from unidic2ud import unidic2ud, UniDic2UDEntry, UniDic2UD
...
class UD2UDParser:
    def __init__(self, name: str = None):
        self.name = name
        self._lazy_parser = Lazy(lambda: unidic2ud.load(name))
...
default = UD2UDParser()  # As alternative? When differing from kindai, usually seems worse but significantly different. Polarity negative feature. Good for something?
