...
public class JsonReader
{
    ...
    private JsonElement GetProperty(string prop, JsonElement? defaultValue = null)
    {
    ...
    private JsonElement GetProperty(IEnumerable<string> props, JsonElement? defaultValue = null)
    {
    ...
    public HashSet<string> GetStringSet(string key, List<string>? defaultValue = null)
    {
        return GetStringList(key, defaultValue).ToHashSet();
    }

    public HashSet<string> GetStringSet(IEnumerable<string> keys, List<string>? defaultValue = null)
    {
        return GetStringList(keys, defaultValue).ToHashSet();
    }
