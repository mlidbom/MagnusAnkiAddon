...
public abstract class JPNote
{
    ...
    public JPNoteData GetData()
    {
        return new JPNoteData(GetId(), _fields, Tags.ToInternedStringList());
    }
    ...
    public virtual HashSet<JPNote> GetDirectDependencies()
    {
    ...
    private HashSet<JPNote> GetDependenciesRecursive(HashSet<JPNote> found)
    {
    ...
    public HashSet<JPNote> GetDependenciesRecursive()
    {
        return GetDependenciesRecursive(new HashSet<JPNote>());
    }
