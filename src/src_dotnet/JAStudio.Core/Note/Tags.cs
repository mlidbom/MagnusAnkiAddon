...
{
    private const string FRoot = "-::";
    private const string FSentence = FRoot + "sentence::";
    private const string FKanji = FRoot + "kanji::";
    private const string FSentenceUses = FSentence + "uses::";
    private const string FVocab = FRoot + "vocab::";
    private const string FVocabMatching = FVocab + "matching::";
    private const string FVocabRegister = FVocab + "register::";
    private const string FVocabMatchingRequires = FVocabMatching + "requires::";
    private const string FVocabMatchingForbids = FVocabMatching + "forbids::";
    private const string FVocabMatchingTodo = FVocabMatching + "todo::";
    private const string FVocabMatchingUses = FVocabMatching + "uses::";
