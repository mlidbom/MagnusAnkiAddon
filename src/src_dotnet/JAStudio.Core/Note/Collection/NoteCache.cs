...
public abstract class NoteCacheBase<TNote> where TNote : JPNote
{
   ...
   public async Task LoadAsync()
   {
      ...
      var noteData = await runner.RunOnBackgroundThreadWithSpinningProgressDialogAsync($"Fetching {_noteType.Name} notes from anki db", () => NoteBulkLoader.LoadAllNotesOfType(dbPath, NoteTypes.FromType(_noteType)));
