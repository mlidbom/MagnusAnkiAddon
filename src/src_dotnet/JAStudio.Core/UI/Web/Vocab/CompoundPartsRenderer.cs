...
public static class CompoundPartsRenderer
{
    ...
    private static string RenderVocabList(List<CompoundPart> vocabList, string title, string cssClass, bool reading = true)
    {
    ...
    private static List<CompoundPart> GetCompoundPartsRecursive(VocabNote vocabNote, int depth = 0, HashSet<NoteId>? visited = null)
    {
