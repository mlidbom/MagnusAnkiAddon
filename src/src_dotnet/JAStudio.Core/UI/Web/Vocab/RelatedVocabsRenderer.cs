...
public class RelatedVocabsRenderer
{
   ...
   internal RelatedVocabsRenderer(VocabCollection vocab) => _vocab = vocab;
    ...
    private static string RenderVocabList(List<VocabNote> vocabList, string title, string cssClass, bool reading = true, bool noSentenceStatistics = true)
    {
    ...
    public static string GenerateStemVocabs(VocabNote vocabNote)
    {
    ...
    public static string GenerateMetaTags(VocabNote vocabNote)
    {
        return vocabNote.MetaData.MetaTagsHtml(true);
    }
}
