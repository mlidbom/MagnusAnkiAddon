...
static class ForbidsIsGodanPotentialInflectionWithBase
{
   static readonly FailedMatchRequirement Failed = FailedMatchRequirement.Forbids("godan_potential_surface");
