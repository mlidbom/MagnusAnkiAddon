...
{
    private static string FormatFinger(char finger, string text) => $"_{finger} {text}";
    ...
    private static readonly Func<string, string>[] NumpadFunctions = 
    [
    ...
    private static readonly Func<string, string>[] FingersByPriorityOrder = 
    [
