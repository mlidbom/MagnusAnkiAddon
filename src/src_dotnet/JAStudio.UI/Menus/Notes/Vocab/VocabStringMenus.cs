...
public class VocabStringMenus
{
      ...
      var items = new List<SpecMenuItem>
                  {
                     SpecMenuItem.Command(ShortcutFinger.Home1("Synonym"),
                                          () => vocab.RelatedNotes.Synonyms.Add(text),
                                          null,
                                          null,
                     ...
                     SpecMenuItem.Command(ShortcutFinger.Home3("Confused with"),
                                          () => vocab.RelatedNotes.ConfusedWith.Add(text),
                                          null,
                                          null,
                                          !confusedWith.Contains(text)),
                     SpecMenuItem.Command(ShortcutFinger.Home4("Antonym"),
                                          () => vocab.RelatedNotes.Antonyms.Add(text),
                                          null,
                                          null,
                                          !antonyms.Contains(text)),
                     SpecMenuItem.Command(ShortcutFinger.Home5("Form"),
                                          () => vocab.Forms.Add(text),
                                          null,
                                          null,
                                          !forms.Contains(text)),
                     SpecMenuItem.Command(ShortcutFinger.Up1("See also"),
                                          () => vocab.RelatedNotes.SeeAlso.Add(text),
                                          null,
                                          null,
                                          !seeAlso.Contains(text)),
                     SpecMenuItem.Command(ShortcutFinger.Down1("Perfect synonym, automatically synchronize answers"),
                                          () => vocab.RelatedNotes.PerfectSynonyms.AddOverwritingTheAnswerOfTheAddedSynonym(text),
                                          null,
                                          null,
                                          !perfectSynonyms.Contains(text))
                  };
   ...
   static SpecMenuItem BuildRemoveMenuSpec(string text, VocabNote vocab)
   {
      ...
      var items = new List<SpecMenuItem>
                  {
                     SpecMenuItem.Command(ShortcutFinger.Home1("Synonym"),
                                          () => vocab.RelatedNotes.Synonyms.Remove(text),
                                          null,
                                          null,
                                          synonyms.Contains(text)),
                     SpecMenuItem.Command(ShortcutFinger.Home2("Confused with"),
                                          () => vocab.RelatedNotes.ConfusedWith.Remove(text),
                                          null,
                                          null,
                                          confusedWith.Contains(text)),
                     SpecMenuItem.Command(ShortcutFinger.Home3("Antonym"),
                                          () => vocab.RelatedNotes.Antonyms.Remove(text),
                                          null,
                                          null,
                                          antonyms.Contains(text)),
                     SpecMenuItem.Command(ShortcutFinger.Home4("Ergative twin"),
                                          () => vocab.RelatedNotes.ErgativeTwin.Remove(),
                                          null,
                                          null,
                                          text == ergativeTwin),
                     SpecMenuItem.Command(ShortcutFinger.Home5("Form"),
                                          () => vocab.Forms.Remove(text),
                                          null,
                                          null,
                                          forms.Contains(text)),
                     SpecMenuItem.Command(ShortcutFinger.Up1("See also"),
                                          () => vocab.RelatedNotes.SeeAlso.Remove(text),
                                          null,
                                          null,
                                          seeAlso.Contains(text)),
                     SpecMenuItem.Command(ShortcutFinger.Down1("Perfect synonym"),
                                          () => vocab.RelatedNotes.PerfectSynonyms.Remove(text),
                                          null,
                                          null,
                                          perfectSynonyms.Contains(text)),
                     SpecMenuItem.Command(ShortcutFinger.Down2("Derived from"),
                                          () => vocab.RelatedNotes.DerivedFrom.Set(""),
                                          null,
                                          null,
                                          text == derivedFrom)
                  };
