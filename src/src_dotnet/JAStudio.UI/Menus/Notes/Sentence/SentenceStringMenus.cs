...
public static class SentenceStringMenus
{
    ...
    private static SpecMenuItem BuildRemoveMenuSpec(SentenceNote sentence, string menuString)
    {
    ...
    private static SpecMenuItem BuildSplitWithWordBreakTagSpec(SentenceNote sentence, string menuString)
    {
