...
namespace JAStudio.Core.Tests.LanguageServices.JanomeEx.Tokenizing;
...
{
    private readonly JNTokenizer _tokenizer;

    public ExploreTokenPartOfSpeechInformationTests()
    {
        _tokenizer = new JNTokenizer();
    }
