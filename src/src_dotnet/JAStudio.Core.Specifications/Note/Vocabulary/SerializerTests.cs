...
public class RelatedVocabDataSerializerTests : SpecificationStartingWithAnEmptyCollection
{
...
public class VocabNoteMatchingRulesSerializerTests : SpecificationStartingWithAnEmptyCollection
{
