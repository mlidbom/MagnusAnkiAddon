...
test_special_vocab: list[VocabSpec] = [
        ...
        VocabSpec("あれても", forms=["れても"], compounds=["あれる", "ても"], tags=[vm.yield_last_token_to_overlapping_compound, vm.Requires.irrealis, vm.Requires.godan, vm.Forbids.godan_potential, Tags.Vocab.question_overrides_form]),
        ...
        VocabSpec("てしまいます", tags=[vm.Requires.te_form_stem]),

        VocabSpec("う以上", tags=[vm.Requires.dictionary_form_stem]),
]
