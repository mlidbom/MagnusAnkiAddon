...
from jastudio.note.vocabulary.related_vocab.Antonyms import Antonyms
from jastudio.note.vocabulary.related_vocab.ergative_twin import ErgativeTwin
from jastudio.note.vocabulary.related_vocab.perfect_synonyms import PerfectSynonyms
