...
from language_services.janome_ex.tokenizing.godan_dictionary_form_stem import GodanPotentialDictionaryFormStem, GodanPotentialInflectionDictionaryFormInflection, GodanPotentialInflectionDictionaryFormStem
...
class IchidanGodanPotentialOrImperativeHybridSplitter(Slots):
    ...
    def _split_godan_potential(cls, token: JNToken, godan_base: str) -> list[IAnalysisToken]:
        ...
        if is_dictionary_form:
            ...
            return [GodanPotentialDictionaryFormStem(token, surface=godan_surface, base=godan_base),
                    GodanPotentialInflectionDictionaryFormStem(token, surface=potential_surface, base=potential_base),
                    GodanPotentialInflectionDictionaryFormInflection(token)]
