    ...
    class Vocab:
        ...
        class Matching:
            ...
            class Requires:
                ...
                past_tense_stem = f"{f_vocab_matching_requires}past-tense-stem"
                t_form_stem = f"{f_vocab_matching_requires}t-form-stem"
                ...
                compound = f"{f_vocab_matching_requires}compound"
