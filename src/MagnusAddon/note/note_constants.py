...
class Mine:
    ...
    class Tags:
        ...
        kanji_with_no_studying_vocab = f"{kanji_folder}no-studying-vocab"
        kanji_with_single_kanji_vocab = f"{kanji_folder}single-kanji-vocab"
        kanji_not_in_any_vocab_main_form = f"{kanji_folder}not-in-any-vocab-main-form"
        kanji_not_in_any_vocab_form = f"{kanji_folder}not-in-any-vocab-form"
        ...
        kanji_with_no_studying_vocab_with_primary_on_reading = f"{kanji_folder}no-studying-vocab-with-primary-on-reading"
