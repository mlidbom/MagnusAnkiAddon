...
class _Cache:
    ...
    def with_form(self, form:str) -> list[VocabNote]:
        self._merge_pending()
        return list(self._by_form[form])
    ...
    def remove_note(self, note: VocabNote) -> None:
        assert note.get_id()
    ...
    def add_note(self, note: VocabNote) -> None:
        assert note.get_id()
