...
class _SentenceSnapshot(CachedNote, Slots):
    def __init__(self, note: SentenceNote) -> None:
        ...
        self.user_highlighted_vocab_forms:set[str] = set(note.configuration.highlighted_words())
        self.user_highlighted_vocab_ids:set[int] = note.configuration.highlighted_vocab_ids
