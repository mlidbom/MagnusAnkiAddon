...
def build_local_menu(sub_menu: QMenu) -> None:
    ...
    # add_menu_ui_action(sub_menu, "Backup kanji readings", local_note_updater.backup_kanji_readings)
    add_menu_ui_action(sub_menu, "Adjust kanji readings", local_note_updater.adjust_kanji_primary_readings)
    add_menu_ui_action(sub_menu, "Remove kun readings html", local_note_updater.remove_kun_readings_html)
