...
def register_lookup_actions(view: AnkiWebView, root_menu: QMenu) -> None:
    ...
    for string_menu, menu_string in string_menus:
        setup_anki_open_menu(non_optional(string_menu.addMenu(shortcutfinger.up1("Open in Anki"))), menu_string)

    for string_menu, menu_string in string_menus:
        setup_web_search_menu(non_optional(string_menu.addMenu(shortcutfinger.down1("Search Web"))), menu_string)
