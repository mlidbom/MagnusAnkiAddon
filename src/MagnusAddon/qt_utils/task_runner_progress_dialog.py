...
class TaskRunner(ProfilableAutoSlots):
    @staticmethod
...
class InvisibleTaskRunner(ITaskRunner, ProfilableAutoSlots):
...
class QtTaskProgressRunner(ITaskRunner, ProfilableAutoSlots):
