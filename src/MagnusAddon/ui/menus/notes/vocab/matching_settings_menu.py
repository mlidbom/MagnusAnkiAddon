...
def build_tag_toggling_menu(toggle_flags_menu: QMenu, vocab: VocabNote) -> None:
    ...
    def build_requires_forbids_menu(requires_forbids_menu: QMenu) -> None:
        ...
        def build_stem_menu(stem_menu: QMenu) -> None:
            ...
            add_require_forbid_menu(stem_menu, shortcutfinger.home3("masu stem"), vocab.matching_configuration.requires_forbids.masu_stem)
            add_require_forbid_menu(stem_menu, shortcutfinger.home4("past tense stem"), vocab.matching_configuration.requires_forbids.past_tense_stem)
            add_require_forbid_menu(stem_menu, shortcutfinger.home5("て-form stem"), vocab.matching_configuration.requires_forbids.te_form_stem)
            add_require_forbid_menu(stem_menu, shortcutfinger.up1("godan potential"), vocab.matching_configuration.requires_forbids.godan_potential)
    ...
    def build_register_menu(register_menu: QMenu) -> None:
        add_tag_field_check_box(register_menu, shortcutfinger.home1("Polite"), vocab.register.polite, reparse_sentences=False)
        add_tag_field_check_box(register_menu, shortcutfinger.home2("Formal"), vocab.register.formal, reparse_sentences=False)
        add_tag_field_check_box(register_menu, shortcutfinger.home3("Informal"), vocab.register.informal, reparse_sentences=False)
        add_tag_field_check_box(register_menu, shortcutfinger.home4("Rough, traditionally considered male"), vocab.register.rough_masculine, reparse_sentences=False)
        add_tag_field_check_box(register_menu, shortcutfinger.home5("Soft, traditionally considered feminine"), vocab.register.soft_feminine, reparse_sentences=False)
        add_tag_field_check_box(register_menu, shortcutfinger.up1("Humble"), vocab.register.humble, reparse_sentences=False)
        add_tag_field_check_box(register_menu, shortcutfinger.up2("Honorific"), vocab.register.honorific, reparse_sentences=False)
        add_tag_field_check_box(register_menu, shortcutfinger.up3("Slang"), vocab.register.slang, reparse_sentences=False)
        add_tag_field_check_box(register_menu, shortcutfinger.up4("Derogatory"), vocab.register.derogatory, reparse_sentences=False)
        add_tag_field_check_box(register_menu, shortcutfinger.up5("Vulgar, usually offensive"), vocab.register.vulgar, reparse_sentences=False)
        add_tag_field_check_box(register_menu, shortcutfinger.down1("Archaic"), vocab.register.archaic, reparse_sentences=False)
        add_tag_field_check_box(register_menu, shortcutfinger.down2("Childish"), vocab.register.childish, reparse_sentences=False)
        add_tag_field_check_box(register_menu, shortcutfinger.down3("Literary"), vocab.register.literary, reparse_sentences=False)
