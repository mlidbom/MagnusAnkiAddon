...
from language_services.janome_ex.tokenizing.godan_dictionary_form_stem import GodanPotentialInflectionDictionaryFormInflection, GodanPotentialInflectionDictionaryFormStem
