...
class TextAnalysis(WeakRefable, AutoSlots):
    ...
    def __init__(self, sentence: str, sentence_configuration: SentenceConfiguration) -> None:
        ...
        self.all_matches: QList[Match] = self.indexing_word_variants.select_many(lambda variant: variant.matches).to_list()
        ...
        self.display_matches:QList[Match] = self.all_matches.where(lambda match: match.is_displayed).to_list()
