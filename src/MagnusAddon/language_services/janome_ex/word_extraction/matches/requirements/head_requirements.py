...
class HeadRequirements(Slots):
    ...
    def __init__(self, match: VocabMatch, word_variant: WeakRef[CandidateWordVariant], end_of_stem: WeakRef[TextAnalysisLocation] | None) -> None:
        ...
        self.fulfills_is_strictly_suffix = not rules.bool_flags.is_strictly_suffix.is_set() or self.has_prefix
        ...
        self.fulfills_forbids_a_stem_requirement = not rules.requires_forbids.a_stem.is_forbidden or not self.has_a_stem
        self.fulfills_requires_a_stem = not rules.requires_forbids.a_stem.is_required or self.has_a_stem
        ...
        self.fulfills_forbids_past_tense_stem = not rules.requires_forbids.past_tense_stem.is_forbidden or not self.has_past_tense_stem
        self.fulfills_requires_past_tense_stem = not rules.requires_forbids.past_tense_stem.is_required or self.has_past_tense_stem
        ...
        self.fulfills_requires_t_form_stem = not rules.requires_forbids.t_form_stem.is_required or self.has_t_form_stem
        self.fulfills_forbids_t_form_stem = not rules.requires_forbids.t_form_stem.is_forbidden or not self.has_t_form_stem
        ...
        self.fulfills_requires_e_stem_requirement = not rules.requires_forbids.e_stem.is_required or self.has_e_stem
        self.fulfills_forbids_e_stem_requirement = not rules.requires_forbids.e_stem.is_forbidden or not self.has_e_stem
