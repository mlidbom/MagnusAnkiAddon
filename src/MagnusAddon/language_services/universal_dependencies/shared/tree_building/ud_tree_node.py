...
class UDTreeNode:
    ...
    def build_lemma(self) -> str:
        ...
        # the default lemma todo not at all sure that this as a reasonable approach. Just how many nonsense results are generated by this that just cause trouble?
        return "".join(tok.form for tok in self.tokens[:-1]) + self.tokens[-1].lemma
        #What happens if we stop guessing wildly here?
        #return ""