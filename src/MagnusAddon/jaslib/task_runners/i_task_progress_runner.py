...
class ITaskRunner:
    ...
    def set_label_text(self, text: str) -> None: raise NotImplementedError()  # pyright: ignore[reportUnusedParameter]
    def close(self) -> None: raise NotImplementedError()
    # noinspection PyUnusedFunction, Annotator
    def run_on_background_thread_with_spinning_progress_dialog[TResult](self, message: str, action: Callable[[], TResult]) -> TResult: raise NotImplementedError()  # pyright: ignore[reportUnusedParameter]
