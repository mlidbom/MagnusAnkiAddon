...
class ConfigurationCache:
    ...
    def __init__(self) -> None:
        self._hide_transparent_compounds = app.config().hide_compositionally_transparent_compounds.get_value()
        self._hide_all_compounds = app.config().hide_all_compounds.get_value()
    ...
    @staticmethod
    def _replace_instance(value: object) -> None:
        ConfigurationCache._instance = ConfigurationCache()
