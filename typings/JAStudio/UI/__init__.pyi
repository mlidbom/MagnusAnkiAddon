...
class AppDialogs:
    ...
    def ShowKanjiEditorDialog(self, kanjiId: int) -> None: ...
    def ShowOptionsDialog(self) -> None: ...
    def ShowReadingsMappingsDialog(self) -> None: ...
    def ShowSentenceEditorDialog(self, sentenceId: int) -> None: ...
    def ShowVocabEditorDialog(self, vocabId: int) -> None: ...
    ...
    class ShowDialog_MethodGroup:
        ...
        class ShowDialog_1(typing.Generic[ShowDialog_1_T1]):
            ShowDialog_1_T = AppDialogs.ShowDialog_MethodGroup.ShowDialog_1_T1
...
class JAStudioAppRoot:
    @property
    def Dialogs(self) -> AppDialogs: ...
    @property
    def Menus(self) -> AppMenus: ...
    @property
