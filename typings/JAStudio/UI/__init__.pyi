...
class DialogHost(abc.ABC):
    ...
    @staticmethod
    def ShowKanjiContextMenu(refreshCallback: Action, executeLookup: Action_1[str], selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowOptionsDialog() -> None: ...
    @staticmethod
    def ShowSentenceContextMenu(refreshCallback: Action, executeLookup: Action_1[str], selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowTestContextMenu(selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowTestMainMenu(x: int, y: int) -> None: ...
    @staticmethod
    def ShowVocabContextMenu(refreshCallback: Action, executeLookup: Action_1[str], selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
