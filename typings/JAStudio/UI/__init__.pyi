...
class DialogHost(abc.ABC):
    ...
    @staticmethod
    def ShowGenericContextMenu(refreshCallback: Action, selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowJapaneseMainMenu(refreshCallback: Action, x: int, y: int) -> None: ...
    @staticmethod
    def ShowKanjiContextMenu(refreshCallback: Action, selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowSentenceContextMenu(refreshCallback: Action, selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowTestContextMenu(selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowTestMainMenu(x: int, y: int) -> None: ...
    @staticmethod
    def ShowVocabContextMenu(refreshCallback: Action, selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
