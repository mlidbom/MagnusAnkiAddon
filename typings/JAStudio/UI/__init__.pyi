...
class DialogHost(abc.ABC):
    ...
    @staticmethod
    def ShowGenericContextMenu(selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowJapaneseMainMenu(searchText: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowKanjiContextMenu(kanjiId: int, selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowOptionsDialog() -> None: ...
    @staticmethod
    def ShowReadingsMappingsDialog() -> None: ...
    @staticmethod
    def ShowSentenceContextMenu(sentenceId: int, selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowTestContextMenu(selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowTestMainMenu(x: int, y: int) -> None: ...
    @staticmethod
    def ShowVocabContextMenu(vocabId: int, selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowVocabFlagsDialog(vocabId: int) -> None: ...
    @staticmethod
    def Shutdown() -> None: ...
    @staticmethod
    def ToggleEnglishWordSearchDialog() -> None: ...
    @staticmethod
    def ToggleNoteSearchDialog() -> None: ...
