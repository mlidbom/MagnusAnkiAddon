...
class DialogHost(abc.ABC):
    ...
    @staticmethod
    def ShowGenericContextMenu(refreshCallback: Action, executeLookup: Action_1[str], selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowJapaneseMainMenu(refreshCallback: Action, executeLookup: Action_1[str], searchText: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowKanjiContextMenu(refreshCallback: Action, executeLookup: Action_1[str], kanjiId: int, selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowOptionsDialog() -> None: ...
    @staticmethod
    def ShowSentenceContextMenu(refreshCallback: Action, executeLookup: Action_1[str], sentenceId: int, selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowTestContextMenu(selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowTestMainMenu(x: int, y: int) -> None: ...
    @staticmethod
    def ShowVocabContextMenu(refreshCallback: Action, executeLookup: Action_1[str], vocabId: int, selection: str, clipboard: str, x: int, y: int) -> None: ...
    @staticmethod
    def ShowVocabFlagsDialog(vocabId: int) -> None: ...
    @staticmethod
    def Shutdown() -> None: ...
