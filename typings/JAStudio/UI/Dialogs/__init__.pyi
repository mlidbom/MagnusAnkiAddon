import typing
from JAStudio.Core.TaskRunners import IScopePanel, ITaskProgressRunner, ThreadCount
...
from Avalonia.Controls import Window, WindowTransparencyLevel, Classes, WindowClosingBehavior, ContextMenu, ITemplate_1, Control, WindowIcon, WindowBase, IResourceDictionary, Screens, SizeToContent, SystemDecorations, WindowStartupLocation, WindowState, UserControl
...
class AvaloniaScopePanel(IScopePanel):
    def __init__(self, panel: TaskProgressScopePanel) -> None: ...
    @property
    def Panel(self) -> TaskProgressScopePanel: ...
    def Dispose(self) -> None: ...
    def GetFinalElapsed(self) -> str: ...


class AvaloniaTaskProgressRunner(ITaskProgressRunner):
    def __init__(self, scopePanel: TaskProgressScopePanel, labelText: str, allowCancel: bool) -> None: ...
    def Close(self) -> None: ...
    def Dispose(self) -> None: ...
...
class MultiTaskProgressDialog(Window):
    ...
    @staticmethod
    def CreateScopePanel(scopeTitle: str, depth: int) -> TaskProgressScopePanel: ...
    @staticmethod
    def Hold() -> None: ...
...
class TaskProgressPanel(UserControl):
    def __init__(self) -> None: ...
    @property
    def ActualThemeVariant(self) -> ThemeVariant: ...
    @property
    ...
    def SetMessage(self, message: str) -> None: ...
    def SetProgress(self, current: int, total: int) -> None: ...
    def SetTimeStats(self, elapsed: str, remaining: str, estimatedTotal: str) -> None: ...
    def ShowCancelButton(self, show: bool) -> None: ...
    def __getitem__(self, property: AvaloniaProperty) -> typing.Any: ...
    def __setitem__(self, property: AvaloniaProperty, value: typing.Any) -> None: ...
    def __getitem__(self, binding: IndexerDescriptor) -> IBinding: ...
...
class TaskProgressScopePanel(UserControl):
    ...
    @ZIndex.setter
    def ZIndex(self, value: int) -> int: ...
    def CreateChildPanel(self, message: str, allowCancel: bool) -> TaskProgressPanel: ...
    def GetFinalElapsed(self) -> str: ...
    def InitializeComponent(self, loadXaml: bool = ...) -> None: ...
    def RemoveChildPanel(self, panel: TaskProgressPanel) -> None: ...
