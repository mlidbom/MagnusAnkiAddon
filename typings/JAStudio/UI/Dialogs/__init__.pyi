...
class AvaloniaScopePanel(IScopePanel):
    def __init__(self, viewModel: TaskProgressScopeViewModel, topLevelPanel: TaskProgressScopePanel, parentScope: IScopePanel) -> None: ...
    @property
...
class TaskProgressDialog(Window):
    ...
    @WasCanceled.setter
    def WasCanceled(self, value: bool) -> bool: ...
    @property
    def Width(self) -> float: ...
    @Width.setter
    def Width(self, value: float) -> float: ...
