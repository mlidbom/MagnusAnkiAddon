...
from JAStudio.Core.Note import KanjiNote, NoteId
from JAStudio.Core import TemporaryServiceCollection
from JAStudio.UI.ViewModels import MissingFileRow
...
class ContextMenuPopup(UserControl):
    ...
    @ZIndex.setter
    def ZIndex(self, value: int) -> int: ...
    def CreateContextMenu(self) -> ContextMenu: ...
    def InitializeComponent(self, loadXaml: bool = ...) -> None: ...
    def ShowAt(self, x: int, y: int) -> None: ...
    def __getitem__(self, property: AvaloniaProperty) -> typing.Any: ...
    def __setitem__(self, property: AvaloniaProperty, value: typing.Any) -> None: ...
    def __getitem__(self, binding: IndexerDescriptor) -> IBinding: ...
    def __setitem__(self, binding: IndexerDescriptor, value: IBinding) -> None: ...
...
class EnglishWordSearchDialog(Window):
    def __init__(self) -> None: ...
    @property
    def ActualThemeVariant(self) -> ThemeVariant: ...
    @property
...
class KanjiEditorDialog(Window):
    @typing.overload
    def __init__(self) -> None: ...
    @typing.overload
...
class MediaImportDialog(Window):
    @typing.overload
    def __init__(self) -> None: ...
    @typing.overload
...
class MissingFilesDialog(Window):
    @typing.overload
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, vocabRows: List_1[MissingFileRow], sentenceRows: List_1[MissingFileRow], kanjiRows: List_1[MissingFileRow], openNote: Action_1[NoteId]) -> None: ...
    @property
    def ActualThemeVariant(self) -> ThemeVariant: ...
    @property
    def ActualTransparencyLevel(self) -> WindowTransparencyLevel: ...
...
class NoteSearchDialog(Window):
    ...
    def InitializeComponent(self, loadXaml: bool = ...) -> None: ...
    @staticmethod
    def ToggleVisibility(services: TemporaryServiceCollection) -> None: ...
    def __getitem__(self, property: AvaloniaProperty) -> typing.Any: ...
    def __setitem__(self, property: AvaloniaProperty, value: typing.Any) -> None: ...
    def __getitem__(self, binding: IndexerDescriptor) -> IBinding: ...
    def __setitem__(self, binding: IndexerDescriptor, value: IBinding) -> None: ...
...
class SentenceEditorDialog(Window):
    @typing.overload
    def __init__(self) -> None: ...
    @typing.overload
...
class VocabEditorDialog(Window):
    @typing.overload
    def __init__(self) -> None: ...
    @typing.overload
...
class VocabFlagsDialog(Window):
    @typing.overload
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, vocab: VocabNote, services: TemporaryServiceCollection) -> None: ...
    @property
    def ActualThemeVariant(self) -> ThemeVariant: ...
    @property
    def ActualTransparencyLevel(self) -> WindowTransparencyLevel: ...
