...
class IUIDispatcher(typing.Protocol):
    @abc.abstractmethod
    def CheckAccess(self) -> bool: ...
    def InitializeDialogViewModel(self, viewModel: TaskProgressDialogViewModel) -> None: ...
    @abc.abstractmethod
    def Invoke(self, action: Action) -> None: ...
    @abc.abstractmethod
    def Post(self, action: Action) -> None: ...
    @abc.abstractmethod
    def PumpEvents(self) -> None: ...
...
class TaskProgressDialogViewModel(NotifyPropertyChangedBase):
    def __init__(self) -> None: ...
    @property
    ...
    @property
    def RootScopes(self) -> ObservableCollection_1[TaskProgressScopeViewModel]: ...
...
class TaskRunner:
    @property
    def DialogViewModel(self) -> TaskProgressDialogViewModel: ...
