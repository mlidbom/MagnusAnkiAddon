...
from System import Func_2, Func_1, IDisposable, Action_1, Action, DateTime, Func_3, Func_4, IEquatable_1
...
class TaskProgressViewModel(INotifyPropertyChanged):
    ...
    def IsIndeterminate(self, value: bool) -> bool: ...
    @property
...
class TaskRunner:
    ...
    def SetUiScopePanelFactory(self, factory: Func_3[str, int, IScopePanel]) -> None: ...
