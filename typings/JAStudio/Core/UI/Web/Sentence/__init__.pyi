...
class QuestionRenderer:
    def RenderSourceQuestion(self, note: SentenceNote) -> str: ...
    def RenderUserQuestion(self, note: SentenceNote) -> str: ...
...
class UdSentenceBreakdownRenderer:
    def RenderSentenceAnalysis(self, note: SentenceNote) -> str: ...
