...
class TextAnalysis:
    def __init__(self, services: AnalysisServices, sentence: str, sentenceConfiguration: SentenceConfiguration, forUI: bool = ..., cachedJanomeTokens: str = ...) -> None: ...
    Version : str
    @property
    def Configuration(self) -> SentenceConfiguration: ...
    @property
    ...
    @property
    def SerializedJanomeTokens(self) -> str: ...
    @property
