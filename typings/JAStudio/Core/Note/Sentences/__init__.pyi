import typing
from JAStudio.Core.Note.CorpusData import SentenceConfigSubData, SentenceData, CorpusDataBase
from JAStudio.Core.Note import NoteGuard, NoteId, JPNote, NoteServices, NoteFlushGuard, NoteTags, Tag
...
from JAStudio.Core.Note.NoteFields import WritableStringValue, StripHtmlOnReadFallbackStringField, SentenceQuestionField, WritableImageValue, MediaReference
...
class CachingSentenceConfigurationField:
    def __init__(self, sentence: SentenceNote, data: SentenceConfigSubData, guard: NoteGuard) -> None: ...
    @property
...
class SentenceNote(JPNote):
    ...
    @property
    def ActiveQuestion(self) -> WritableStringValue: ...
    @property
    ...
    @property
    def ExternalId(self) -> WritableStringValue: ...
    @property
    def Guard(self) -> NoteGuard: ...
    @property
    def IsFlushing(self) -> bool: ...
    @property
    def JanomeTokens(self) -> WritableStringValue: ...
    @property
    def Question(self) -> SentenceQuestionField: ...
    @property
    def Reading(self) -> WritableStringValue: ...
    @property
    ...
    def GetParsingResult(self) -> ParsingResult: ...
    def GetQuestion(self) -> str: ...
    def GetWords(self) -> List_1[str]: ...
    def SetParsingResult(self, value: ParsingResult) -> None: ...
...
class SentenceUserFields:
    def __init__(self, data: SentenceData, guard: NoteGuard) -> None: ...
    @property
    def Answer(self) -> WritableStringValue: ...
    @property
    def Comments(self) -> WritableStringValue: ...
    @property
    def Question(self) -> WritableStringValue: ...
