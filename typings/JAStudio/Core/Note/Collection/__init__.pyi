import typing, abc
from JAStudio.Core.Note import JPNote, IBackendNoteCreator, NoteServices, KanjiNote, NetNoteData, SentenceNote, VocabNote
...
class NetNoteCacheBase_GenericClasses(abc.ABCMeta):
    Generic_NetNoteCacheBase_GenericClasses_NetNoteCacheBase_1_TNote = typing.TypeVar('Generic_NetNoteCacheBase_GenericClasses_NetNoteCacheBase_1_TNote')
    def __getitem__(self, types : typing.Type[Generic_NetNoteCacheBase_GenericClasses_NetNoteCacheBase_1_TNote]) -> typing.Type[NetNoteCacheBase_1[Generic_NetNoteCacheBase_GenericClasses_NetNoteCacheBase_1_TNote]]: ...

NetNoteCacheBase : NetNoteCacheBase_GenericClasses

NetNoteCacheBase_1_TNote = typing.TypeVar('NetNoteCacheBase_1_TNote')
class NetNoteCacheBase_1(typing.Generic[NetNoteCacheBase_1_TNote], abc.ABC):
    @abc.abstractmethod
    def AddToCache(self, note: NetNoteCacheBase_1_TNote) -> None: ...
    def AnkiNoteUpdated(self, note: NetNoteCacheBase_1_TNote) -> None: ...
    def InitFromList(self, allNotes: List_1[NetNoteData]) -> None: ...
    def JpNoteUpdated(self, note: NetNoteCacheBase_1_TNote) -> None: ...
    def OnNoteUpdated(self, listener: Action_1[NetNoteCacheBase_1_TNote]) -> None: ...
    @abc.abstractmethod
    def RemoveFromCache(self, note: NetNoteCacheBase_1_TNote) -> None: ...
    def SetNoteServices(self, noteServices: NoteServices) -> None: ...
    def SetStudyingStatuses(self, cardStatuses: List_1[CardStudyingStatus]) -> None: ...
    def WithIdOrNone(self, noteId: int) -> NetNoteCacheBase_1_TNote: ...
...
class NoteCache_2(typing.Generic[NoteCache_2_TNote, NoteCache_2_TSnapshot], NetNoteCacheBase_1[NoteCache_2_TNote]):
