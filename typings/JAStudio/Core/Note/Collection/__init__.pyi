import typing, abc
from JAStudio.Core.Note import JPNote, IBackendNoteCreator, NoteServices, KanjiNote, NoteData, SentenceNote, VocabNote
...
class NoteCacheBase_1(typing.Generic[NoteCacheBase_1_TNote], abc.ABC):
    ...
    def InitFromList(self, allNotes: List_1[NoteData]) -> None: ...
    def InitFromListAsync(self, allNotes: List_1[NoteData], runner: ITaskProgressRunner) -> Task: ...
