...
class JPCollection:
    def __init__(self, backendNoteCreator: IBackendNoteCreator, noteServices: NoteServices, config: JapaneseConfig, noteRepository: INoteRepository, alternateRepository: INoteRepository = ..., backendDataLoader: IBackendDataLoader = ...) -> None: ...
    @property
