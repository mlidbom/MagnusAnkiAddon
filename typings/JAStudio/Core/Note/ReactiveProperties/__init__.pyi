...
from System import Func_1, IDisposable, IObservable_1, Array_1, IObserver_1, Action_1, Action, Func_2
...
class CommaSeparatedListProperty:
    def __init__(self, field: StringProperty) -> None: ...
    ...
    class LazyReader_MethodGroup:
        ...
        class LazyReader_1(typing.Generic[LazyReader_1_T1]):
            LazyReader_1_T = CommaSeparatedListProperty.LazyReader_MethodGroup.LazyReader_1_T1
            def __call__(self, reader: Func_1[LazyReader_1_T]) -> LazyCE_1[LazyReader_1_T]:...
...
class DeDuplicatedCommaSeparatedListProperty(CommaSeparatedListProperty):
    def __init__(self, field: StringProperty) -> None: ...
    def Set(self, value: List_1[str]) -> None: ...
