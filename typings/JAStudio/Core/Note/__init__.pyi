...
from JAStudio.Core.Note.NoteFields import MediaReference, WritableAudioField, ImageField, MutableStringField, StripHtmlOnReadFallbackStringField, MutableSerializedObjectField_1, SentenceQuestionField, WritableImageField, MutableCommaSeparatedStringsListField
from JAStudio.Core.Note.CorpusData import CorpusDataBase, KanjiData, SentenceData, VocabData
...
class KanjiId(NoteId, IEquatable_1[KanjiId]):
    ...
    @staticmethod
    def New() -> KanjiId: ...
    def __eq__(self, left: KanjiId, right: KanjiId) -> bool: ...
    def __ne__(self, left: KanjiId, right: KanjiId) -> bool: ...
    # Skipped Equals due to it being static, abstract and generic.

    Equals : Equals_MethodGroup
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: KanjiId) -> bool:...
        @typing.overload
        def __call__(self, other: NoteId) -> bool:...
        @typing.overload
...
class KanjiNote(JPNote):
    ...
    def Guard(self) -> NoteGuard: ...
    @property
    def Image(self) -> ImageField: ...
    @property
    def IsFlushing(self) -> bool: ...
    @property
    def KanjiReferences(self) -> MutableStringField: ...
    @property
    ...
    @property
    def PrimaryReadingsTtsAudio(self) -> MutableStringField: ...
    @property
...
class NoteId(IEquatable_1[NoteId], abc.ABC):
    ...
    def Deconstruct(self, Value: clr.Reference[Guid]) -> None: ...
    def GetHashCode(self) -> int: ...
    def __eq__(self, left: NoteId, right: NoteId) -> bool: ...
    def __ne__(self, left: NoteId, right: NoteId) -> bool: ...
    def ToString(self) -> str: ...
    # Skipped Equals due to it being static, abstract and generic.
...
class SentenceId(NoteId, IEquatable_1[SentenceId]):
    ...
    @staticmethod
    def New() -> SentenceId: ...
    def __eq__(self, left: SentenceId, right: SentenceId) -> bool: ...
    def __ne__(self, left: SentenceId, right: SentenceId) -> bool: ...
    # Skipped Equals due to it being static, abstract and generic.

    Equals : Equals_MethodGroup
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: SentenceId) -> bool:...
        @typing.overload
        def __call__(self, other: NoteId) -> bool:...
        @typing.overload
        def __call__(self, obj: typing.Any) -> bool:...
...
class SentenceNote(JPNote):
    def __init__(self, services: NoteServices, data: SentenceData = ...) -> None: ...
    @property
    ...
    def RecursiveFlushGuard(self) -> NoteFlushGuard: ...
    @property
    def Screenshot(self) -> WritableImageField: ...
    @property
    def Services(self) -> NoteServices: ...
    @property
...
class VocabId(NoteId, IEquatable_1[VocabId]):
    ...
    @staticmethod
    def New() -> VocabId: ...
    def __eq__(self, left: VocabId, right: VocabId) -> bool: ...
    def __ne__(self, left: VocabId, right: VocabId) -> bool: ...
    # Skipped Equals due to it being static, abstract and generic.

    Equals : Equals_MethodGroup
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: VocabId) -> bool:...
        @typing.overload
        def __call__(self, other: NoteId) -> bool:...
        @typing.overload
        def __call__(self, obj: typing.Any) -> bool:...
...
class VocabNote(JPNote):
    ...
    def RecursiveFlushGuard(self) -> NoteFlushGuard: ...
    @property
    def References(self) -> MutableStringField: ...
    @property
    ...
    def SourceAnswer(self) -> MutableStringField: ...
    @property
    def SourceMnemonic(self) -> MutableStringField: ...
    @property
