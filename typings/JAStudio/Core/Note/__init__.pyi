...
class KanjiNote(JPNote):
    def __init__(self, services: NoteServices, data: NetNoteData = ...) -> None: ...
    @property
    def Collection(self) -> JPCollection: ...
    @property
    def IsFlushing(self) -> bool: ...
...
class NetNoteData:
    ...
    @staticmethod
    def FromPythonListOfNoteData(pythonList: typing.Any) -> IReadOnlyList_1[NetNoteData]: ...
...
class NoteTags(IEnumerable_1[Tag]):
    def __init__(self, note: JPNote, data: NetNoteData = ...) -> None: ...
