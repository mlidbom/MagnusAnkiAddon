...
from JAStudio.Core.Note.ReactiveProperties import StringProperty, FallbackHtmlStrippedProperty, AudioProperty, SerializedObjectProperty_1, SentenceQuestionProperty, CommaSeparatedListProperty
from JAStudio.Core.LanguageServices.JanomeEx import AnalysisServices
from JAStudio.Core.Note.Sentences import CachingSentenceConfigurationField, ParsingResult, SentenceUserProperties
...
class SentenceNote(JPNote):
    def __init__(self, services: NoteServices, data: NoteData = ...) -> None: ...
    @property
    def ActiveQuestion(self) -> StringProperty: ...
    @property
    def AnalysisServices(self) -> AnalysisServices: ...
    @property
    def Answer(self) -> FallbackHtmlStrippedProperty: ...
    @property
    def Audio(self) -> AudioProperty: ...
    @property
    def Collection(self) -> JPCollection: ...
    @property
    ...
    @property
    def Id(self) -> StringProperty: ...
    @property
    def IsFlushing(self) -> bool: ...
    @property
    def JanomeTokens(self) -> StringProperty: ...
    @property
    def ParsingResult(self) -> SerializedObjectProperty_1[ParsingResult]: ...
    @property
    def Question(self) -> SentenceQuestionProperty: ...
    @property
    def Reading(self) -> StringProperty: ...
    @property
    def RecursiveFlushGuard(self) -> NoteFlushGuard: ...
    @property
    def Screenshot(self) -> StringProperty: ...
    @property
    def Services(self) -> NoteServices: ...
    @property
    def SourceComments(self) -> StringProperty: ...
    @property
    def SourceQuestion(self) -> StringProperty: ...
    @property
    def Tags(self) -> NoteTags: ...
    @property
    def User(self) -> SentenceUserProperties: ...
    @staticmethod
...
class VocabNote(JPNote):
    def __init__(self, services: NoteServices, data: NoteData = ...) -> None: ...
    @property
    def ActiveAnswer(self) -> StringProperty: ...
    @property
    ...
    @property
    def Readings(self) -> CommaSeparatedListProperty: ...
    @property
    def RecursiveFlushGuard(self) -> NoteFlushGuard: ...
    @property
    ...
    def Services(self) -> NoteServices: ...
    @property
    def SourceAnswer(self) -> StringProperty: ...
    @property
    def Tags(self) -> NoteTags: ...
    @property
