...
from System import SystemException, Exception, IDisposable, IEquatable_1, Action_1, Action, Action_2, IAsyncDisposable, TimeSpan, TimeProvider, Array_1, ReadOnlySpan_1, MulticastDelegate, IAsyncResult, AsyncCallback, UIntPtr, Func_1, MarshalByRefObject, LocalDataStoreSlot, AppDomain, EventArgs, ApplicationException
...
class CancellationTokenSource(IDisposable):
    ...
    class CreateLinkedTokenSource_MethodGroup:
        ...
        @typing.overload
        def __call__(self, tokens: ReadOnlySpan_1[CancellationToken]) -> CancellationTokenSource:...
        @typing.overload
...
class EventWaitHandle(WaitHandle):
    ...
    @typing.overload
    def __init__(self, initialState: bool, mode: EventResetMode, name: str, options: NamedWaitHandleOptions, createdNew: clr.Reference[bool]) -> None: ...
    @property
    def Handle(self) -> int: ...
    @Handle.setter
    def Handle(self, value: int) -> int: ...
    ...
    class OpenExisting_MethodGroup:
        @typing.overload
        def __call__(self, name: str) -> EventWaitHandle:...
        @typing.overload
        def __call__(self, name: str, options: NamedWaitHandleOptions) -> EventWaitHandle:...

    # Skipped TryOpenExisting due to it being static, abstract and generic.

    TryOpenExisting : TryOpenExisting_MethodGroup
    class TryOpenExisting_MethodGroup:
        @typing.overload
        def __call__(self, name: str, result: clr.Reference[EventWaitHandle]) -> bool:...
        @typing.overload
        def __call__(self, name: str, options: NamedWaitHandleOptions, result: clr.Reference[EventWaitHandle]) -> bool:...
...
class Interlocked(abc.ABC):
    ...
    class CompareExchange_MethodGroup:
        ...
        # Method CompareExchange(location1 : SByte&, value : SByte, comparand : SByte) was skipped since it collides with above method
        # Method CompareExchange(location1 : Int16&, value : Int16, comparand : Int16) was skipped since it collides with above method
        # Method CompareExchange(location1 : Byte&, value : Byte, comparand : Byte) was skipped since it collides with above method
        # Method CompareExchange(location1 : UInt16&, value : UInt16, comparand : UInt16) was skipped since it collides with above method
    ...
    class Exchange_MethodGroup:
        ...
        # Method Exchange(location1 : SByte&, value : SByte) was skipped since it collides with above method
        # Method Exchange(location1 : Int16&, value : Int16) was skipped since it collides with above method
        # Method Exchange(location1 : Byte&, value : Byte) was skipped since it collides with above method
        # Method Exchange(location1 : UInt16&, value : UInt16) was skipped since it collides with above method
...
class Mutex(WaitHandle):
    ...
    @typing.overload
    def __init__(self, initiallyOwned: bool, name: str, options: NamedWaitHandleOptions, createdNew: clr.Reference[bool]) -> None: ...
    @typing.overload
    ...
    class OpenExisting_MethodGroup:
        @typing.overload
        def __call__(self, name: str) -> Mutex:...
        @typing.overload
        def __call__(self, name: str, options: NamedWaitHandleOptions) -> Mutex:...
    ...
    class TryOpenExisting_MethodGroup:
        @typing.overload
        def __call__(self, name: str, result: clr.Reference[Mutex]) -> bool:...
        @typing.overload
        def __call__(self, name: str, options: NamedWaitHandleOptions, result: clr.Reference[Mutex]) -> bool:...



class NamedWaitHandleOptions:
    @property
    def CurrentSessionOnly(self) -> bool: ...
    @CurrentSessionOnly.setter
    def CurrentSessionOnly(self, value: bool) -> bool: ...
    @property
    def CurrentUserOnly(self) -> bool: ...
    @CurrentUserOnly.setter
    def CurrentUserOnly(self, value: bool) -> bool: ...
...
class Semaphore(WaitHandle):
    ...
    @typing.overload
    def __init__(self, initialCount: int, maximumCount: int, name: str, options: NamedWaitHandleOptions, createdNew: clr.Reference[bool]) -> None: ...
    @property
    def Handle(self) -> int: ...
    @Handle.setter
    def Handle(self, value: int) -> int: ...
    ...
    class OpenExisting_MethodGroup:
        @typing.overload
        def __call__(self, name: str) -> Semaphore:...
        @typing.overload
        def __call__(self, name: str, options: NamedWaitHandleOptions) -> Semaphore:...
    ...
    class TryOpenExisting_MethodGroup:
        @typing.overload
        def __call__(self, name: str, result: clr.Reference[Semaphore]) -> bool:...
        @typing.overload
        def __call__(self, name: str, options: NamedWaitHandleOptions, result: clr.Reference[Semaphore]) -> bool:...
