import typing, abc
from System import IDisposable, IAsyncResult, Action, Action_1, AggregateException, Func_2, Func_3, Action_2, TimeSpan, TimeProvider, Exception, Func_1, Array_1, ReadOnlySpan_1, IAsyncDisposable, OperationCanceledException, AsyncCallback, Func_4, Func_5, Func_6, EventArgs, IEquatable_1
...
class Task_0(IDisposable, IAsyncResult):
    ...
    class WaitAll_MethodGroup:
        ...
        @typing.overload
        def __call__(self, tasks: ReadOnlySpan_1[Task]) -> None:...
        @typing.overload
        ...
        @typing.overload
        def __call__(self, tasks: IEnumerable_1[Task], cancellationToken: CancellationToken = ...) -> None:...
        @typing.overload
    ...
    class WhenAll_MethodGroup:
        ...
        class WhenAll_1(typing.Generic[WhenAll_1_T1]):
            ...
            @typing.overload
            def __call__(self, tasks: ReadOnlySpan_1[Task_1[WhenAll_1_TResult]]) -> Task_1[Array_1[WhenAll_1_TResult]]:...
            @typing.overload
        ...
        @typing.overload
        def __call__(self, tasks: ReadOnlySpan_1[Task]) -> Task:...
        @typing.overload
    ...
    class WhenAny_MethodGroup:
        ...
        class WhenAny_1(typing.Generic[WhenAny_1_T1]):
            ...
            @typing.overload
            def __call__(self, tasks: ReadOnlySpan_1[Task_1[WhenAny_1_TResult]]) -> Task_1[Task_1[WhenAny_1_TResult]]:...
            @typing.overload
        ...
        @typing.overload
        def __call__(self, tasks: ReadOnlySpan_1[Task]) -> Task_1[Task]:...
        @typing.overload
        def __call__(self, tasks: IEnumerable_1[Task]) -> Task_1[Task]:...
        @typing.overload
        def __call__(self, task1: Task, task2: Task) -> Task_1[Task]:...

    # Skipped WhenEach due to it being static, abstract and generic.

    WhenEach : WhenEach_MethodGroup
    class WhenEach_MethodGroup:
        def __getitem__(self, t:typing.Type[WhenEach_1_T1]) -> WhenEach_1[WhenEach_1_T1]: ...

        WhenEach_1_T1 = typing.TypeVar('WhenEach_1_T1')
        class WhenEach_1(typing.Generic[WhenEach_1_T1]):
            WhenEach_1_TResult = Task_0.WhenEach_MethodGroup.WhenEach_1_T1
            @typing.overload
            def __call__(self, tasks: Array_1[Task_1[WhenEach_1_TResult]]) -> IAsyncEnumerable_1[Task_1[WhenEach_1_TResult]]:...
            @typing.overload
            def __call__(self, tasks: ReadOnlySpan_1[Task_1[WhenEach_1_TResult]]) -> IAsyncEnumerable_1[Task_1[WhenEach_1_TResult]]:...
            @typing.overload
            def __call__(self, tasks: IEnumerable_1[Task_1[WhenEach_1_TResult]]) -> IAsyncEnumerable_1[Task_1[WhenEach_1_TResult]]:...

        @typing.overload
        def __call__(self, tasks: Array_1[Task]) -> IAsyncEnumerable_1[Task]:...
        @typing.overload
        def __call__(self, tasks: ReadOnlySpan_1[Task]) -> IAsyncEnumerable_1[Task]:...
        @typing.overload
        def __call__(self, tasks: IEnumerable_1[Task]) -> IAsyncEnumerable_1[Task]:...
...
class TaskCompletionSource_0:
    ...
    @property
    def Task(self) -> Task: ...
    def SetFromTask(self, completedTask: Task) -> None: ...
    def SetResult(self) -> None: ...
    def TrySetFromTask(self, completedTask: Task) -> bool: ...
...
class TaskCompletionSource_1(typing.Generic[TaskCompletionSource_1_TResult]):
    ...
    def SetFromTask(self, completedTask: Task_1[TaskCompletionSource_1_TResult]) -> None: ...
    def SetResult(self, result: TaskCompletionSource_1_TResult) -> None: ...
    def TrySetFromTask(self, completedTask: Task_1[TaskCompletionSource_1_TResult]) -> bool: ...
