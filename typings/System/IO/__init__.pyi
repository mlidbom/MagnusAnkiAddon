...
from System import IDisposable, Array_1, Decimal, Span_1, Half, IAsyncDisposable, ReadOnlySpan_1, IAsyncResult, AsyncCallback, Memory_1, ReadOnlyMemory_1, DateTime, Exception, MarshalByRefObject, SystemException, ArraySegment_1, IFormatProvider
...
class BinaryReader(IDisposable):
    ...
    def ReadExactly(self, buffer: Span_1[int]) -> None: ...
...
class File(abc.ABC):
    ...
    @staticmethod
    def ResolveLinkTarget(linkPath: str, returnFinalTarget: bool) -> FileSystemInfo: ...
    # Skipped AppendAllBytes due to it being static, abstract and generic.

    AppendAllBytes : AppendAllBytes_MethodGroup
    class AppendAllBytes_MethodGroup:
        @typing.overload
        def __call__(self, path: str, bytes: Array_1[int]) -> None:...
        @typing.overload
        def __call__(self, path: str, bytes: ReadOnlySpan_1[int]) -> None:...

    # Skipped AppendAllBytesAsync due to it being static, abstract and generic.

    AppendAllBytesAsync : AppendAllBytesAsync_MethodGroup
    class AppendAllBytesAsync_MethodGroup:
        @typing.overload
        def __call__(self, path: str, bytes: Array_1[int], cancellationToken: CancellationToken = ...) -> Task:...
        @typing.overload
        def __call__(self, path: str, bytes: ReadOnlyMemory_1[int], cancellationToken: CancellationToken = ...) -> Task:...
    ...
    class AppendAllText_MethodGroup:
        @typing.overload
        def __call__(self, path: str, contents: ReadOnlySpan_1[str]) -> None:...
        @typing.overload
        def __call__(self, path: str, contents: str) -> None:...
        @typing.overload
        def __call__(self, path: str, contents: ReadOnlySpan_1[str], encoding: Encoding) -> None:...
        @typing.overload
    ...
    class AppendAllTextAsync_MethodGroup:
        @typing.overload
        def __call__(self, path: str, contents: ReadOnlyMemory_1[str], cancellationToken: CancellationToken = ...) -> Task:...
        @typing.overload
        def __call__(self, path: str, contents: str, cancellationToken: CancellationToken = ...) -> Task:...
        @typing.overload
        def __call__(self, path: str, contents: ReadOnlyMemory_1[str], encoding: Encoding, cancellationToken: CancellationToken = ...) -> Task:...
        @typing.overload
    ...
    # Skipped WriteAllBytes due to it being static, abstract and generic.

    WriteAllBytes : WriteAllBytes_MethodGroup
    class WriteAllBytes_MethodGroup:
        @typing.overload
        def __call__(self, path: str, bytes: Array_1[int]) -> None:...
        @typing.overload
        def __call__(self, path: str, bytes: ReadOnlySpan_1[int]) -> None:...

    # Skipped WriteAllBytesAsync due to it being static, abstract and generic.

    WriteAllBytesAsync : WriteAllBytesAsync_MethodGroup
    class WriteAllBytesAsync_MethodGroup:
        @typing.overload
        def __call__(self, path: str, bytes: Array_1[int], cancellationToken: CancellationToken = ...) -> Task:...
        @typing.overload
        def __call__(self, path: str, bytes: ReadOnlyMemory_1[int], cancellationToken: CancellationToken = ...) -> Task:...
...
class Path(abc.ABC):
    ...
    class Combine_MethodGroup:
        ...
        @typing.overload
        def __call__(self, paths: ReadOnlySpan_1[str]) -> str:...
        @typing.overload
...
class StreamWriter(TextWriter):
    ...
    class Write_MethodGroup:
        ...
        @typing.overload
        def __call__(self, format: str, arg: ReadOnlySpan_1[typing.Any]) -> None:...
        @typing.overload
...
class TextWriter(MarshalByRefObject, IAsyncDisposable, IDisposable):
    ...
    def Close(self) -> None: ...
    @staticmethod
    def CreateBroadcasting(writers: Array_1[TextWriter]) -> TextWriter: ...
    def Dispose(self) -> None: ...
    def DisposeAsync(self) -> ValueTask: ...
    def Flush(self) -> None: ...
    @staticmethod
