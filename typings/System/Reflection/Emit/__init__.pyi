...
class LocalBuilder(LocalVariableInfo, abc.ABC):
    @property
...
class ModuleBuilder(Module):
    ...
    # Skipped DefineDocument due to it being static, abstract and generic.

    DefineDocument : DefineDocument_MethodGroup
    class DefineDocument_MethodGroup:
        @typing.overload
        def __call__(self, url: str, language: Guid = ...) -> ISymbolDocumentWriter:...
        @typing.overload
        def __call__(self, url: str, language: Guid, languageVendor: Guid, documentType: Guid) -> ISymbolDocumentWriter:...
