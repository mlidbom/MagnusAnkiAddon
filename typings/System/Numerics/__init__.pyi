...
from System import UIntPtr, ValueTuple_2, ReadOnlySpan_1, Span_1, Array_1, IComparable_1, IComparable, ISpanParsable_1, ISpanFormattable, IUtf8SpanParsable_1, IUtf8SpanFormattable, IEquatable_1, MidpointRounding, IFormattable, IFormatProvider
...
class IFloatingPoint_1(typing.Generic[IFloatingPoint_1_TSelf], ISignedNumber_1[IFloatingPoint_1_TSelf], INumber_1[IFloatingPoint_1_TSelf], IFloatingPointConstants_1[IFloatingPoint_1_TSelf], typing.Protocol):
    ...
    # Skipped ConvertToInteger due to it being static, abstract and generic.

    ConvertToInteger : ConvertToInteger_MethodGroup[IFloatingPoint_1_TSelf]
    ConvertToInteger_MethodGroup_IFloatingPoint_1_TSelf = typing.TypeVar('ConvertToInteger_MethodGroup_IFloatingPoint_1_TSelf')
    class ConvertToInteger_MethodGroup(typing.Generic[ConvertToInteger_MethodGroup_IFloatingPoint_1_TSelf]):
        ConvertToInteger_MethodGroup_IFloatingPoint_1_TSelf = IFloatingPoint_1.ConvertToInteger_MethodGroup_IFloatingPoint_1_TSelf
        def __getitem__(self, t:typing.Type[ConvertToInteger_1_T1]) -> ConvertToInteger_1[ConvertToInteger_MethodGroup_IFloatingPoint_1_TSelf, ConvertToInteger_1_T1]: ...

        ConvertToInteger_1_IFloatingPoint_1_TSelf = typing.TypeVar('ConvertToInteger_1_IFloatingPoint_1_TSelf')
        ConvertToInteger_1_T1 = typing.TypeVar('ConvertToInteger_1_T1')
        class ConvertToInteger_1(typing.Generic[ConvertToInteger_1_IFloatingPoint_1_TSelf, ConvertToInteger_1_T1]):
            ConvertToInteger_1_IFloatingPoint_1_TSelf = IFloatingPoint_1.ConvertToInteger_MethodGroup.ConvertToInteger_1_IFloatingPoint_1_TSelf
            ConvertToInteger_1_TInteger = IFloatingPoint_1.ConvertToInteger_MethodGroup.ConvertToInteger_1_T1
            def __call__(self, value: ConvertToInteger_1_IFloatingPoint_1_TSelf) -> ConvertToInteger_1_TInteger:...


    # Skipped ConvertToIntegerNative due to it being static, abstract and generic.

    ConvertToIntegerNative : ConvertToIntegerNative_MethodGroup[IFloatingPoint_1_TSelf]
    ConvertToIntegerNative_MethodGroup_IFloatingPoint_1_TSelf = typing.TypeVar('ConvertToIntegerNative_MethodGroup_IFloatingPoint_1_TSelf')
    class ConvertToIntegerNative_MethodGroup(typing.Generic[ConvertToIntegerNative_MethodGroup_IFloatingPoint_1_TSelf]):
        ConvertToIntegerNative_MethodGroup_IFloatingPoint_1_TSelf = IFloatingPoint_1.ConvertToIntegerNative_MethodGroup_IFloatingPoint_1_TSelf
        def __getitem__(self, t:typing.Type[ConvertToIntegerNative_1_T1]) -> ConvertToIntegerNative_1[ConvertToIntegerNative_MethodGroup_IFloatingPoint_1_TSelf, ConvertToIntegerNative_1_T1]: ...

        ConvertToIntegerNative_1_IFloatingPoint_1_TSelf = typing.TypeVar('ConvertToIntegerNative_1_IFloatingPoint_1_TSelf')
        ConvertToIntegerNative_1_T1 = typing.TypeVar('ConvertToIntegerNative_1_T1')
        class ConvertToIntegerNative_1(typing.Generic[ConvertToIntegerNative_1_IFloatingPoint_1_TSelf, ConvertToIntegerNative_1_T1]):
            ConvertToIntegerNative_1_IFloatingPoint_1_TSelf = IFloatingPoint_1.ConvertToIntegerNative_MethodGroup.ConvertToIntegerNative_1_IFloatingPoint_1_TSelf
            ConvertToIntegerNative_1_TInteger = IFloatingPoint_1.ConvertToIntegerNative_MethodGroup.ConvertToIntegerNative_1_T1
            def __call__(self, value: ConvertToIntegerNative_1_IFloatingPoint_1_TSelf) -> ConvertToIntegerNative_1_TInteger:...
...
class INumber_1(typing.Generic[INumber_1_TSelf], INumberBase_1[INumber_1_TSelf], IComparisonOperators_3[INumber_1_TSelf, INumber_1_TSelf, bool], IModulusOperators_3[INumber_1_TSelf, INumber_1_TSelf, INumber_1_TSelf], IComparable_1[INumber_1_TSelf], IComparable_0, typing.Protocol):
    ...
    @staticmethod
    def ClampNative(value: INumber_1_TSelf, min: INumber_1_TSelf, max: INumber_1_TSelf) -> INumber_1_TSelf: ...
    @staticmethod
    ...
    @staticmethod
    def MaxNative(x: INumber_1_TSelf, y: INumber_1_TSelf) -> INumber_1_TSelf: ...
    @staticmethod
    ...
    @staticmethod
    def MinNative(x: INumber_1_TSelf, y: INumber_1_TSelf) -> INumber_1_TSelf: ...
    @staticmethod
...
class INumberBase_1(typing.Generic[INumberBase_1_TSelf], ISpanParsable_1[INumberBase_1_TSelf], ISpanFormattable, IUtf8SpanParsable_1[INumberBase_1_TSelf], IUtf8SpanFormattable, IUnaryNegationOperators_2[INumberBase_1_TSelf, INumberBase_1_TSelf], IUnaryPlusOperators_2[INumberBase_1_TSelf, INumberBase_1_TSelf], ISubtractionOperators_3[INumberBase_1_TSelf, INumberBase_1_TSelf, INumberBase_1_TSelf], IMultiplyOperators_3[INumberBase_1_TSelf, INumberBase_1_TSelf, INumberBase_1_TSelf], IMultiplicativeIdentity_2[INumberBase_1_TSelf, INumberBase_1_TSelf], IIncrementOperators_1[INumberBase_1_TSelf], IEqualityOperators_3[INumberBase_1_TSelf, INumberBase_1_TSelf, bool], IEquatable_1[INumberBase_1_TSelf], IDivisionOperators_3[INumberBase_1_TSelf, INumberBase_1_TSelf, INumberBase_1_TSelf], IDecrementOperators_1[INumberBase_1_TSelf], IAdditiveIdentity_2[INumberBase_1_TSelf, INumberBase_1_TSelf], IAdditionOperators_3[INumberBase_1_TSelf, INumberBase_1_TSelf, INumberBase_1_TSelf], typing.Protocol):
    ...
    @staticmethod
    def MultiplyAddEstimate(left: INumberBase_1_TSelf, right: INumberBase_1_TSelf, addend: INumberBase_1_TSelf) -> INumberBase_1_TSelf: ...
...
class Matrix3x2(IEquatable_1[Matrix3x2]):
    ...
    def X(self) -> Vector2: ...
    @X.setter
    def X(self, value: Vector2) -> Vector2: ...
    @property
    def Y(self) -> Vector2: ...
    @Y.setter
    def Y(self, value: Vector2) -> Vector2: ...
    @property
    def Z(self) -> Vector2: ...
    @Z.setter
    def Z(self, value: Vector2) -> Vector2: ...
    @staticmethod
    def Add(value1: Matrix3x2, value2: Matrix3x2) -> Matrix3x2: ...
    def GetDeterminant(self) -> float: ...
    def GetElement(self, row: int, column: int) -> float: ...
    def GetHashCode(self) -> int: ...
    def GetRow(self, index: int) -> Vector2: ...
    @staticmethod
    ...
    def WithElement(self, row: int, column: int, value: float) -> Matrix3x2: ...
    def WithRow(self, index: int, value: Vector2) -> Matrix3x2: ...
    # Skipped Create due to it being static, abstract and generic.

    Create : Create_MethodGroup
    class Create_MethodGroup:
        @typing.overload
        def __call__(self, value: float) -> Matrix3x2:...
        @typing.overload
        def __call__(self, value: Vector2) -> Matrix3x2:...
        @typing.overload
        def __call__(self, x: Vector2, y: Vector2, z: Vector2) -> Matrix3x2:...
        @typing.overload
        def __call__(self, m11: float, m12: float, m21: float, m22: float, m31: float, m32: float) -> Matrix3x2:...
    ...
    def __getitem__(self, row: int) -> Vector2: ...
    def __setitem__(self, row: int, value: Vector2) -> None: ...
...
class Matrix4x4(IEquatable_1[Matrix4x4]):
    ...
    def W(self) -> Vector4: ...
    @W.setter
    def W(self, value: Vector4) -> Vector4: ...
    @property
    def X(self) -> Vector4: ...
    @X.setter
    def X(self, value: Vector4) -> Vector4: ...
    @property
    def Y(self) -> Vector4: ...
    @Y.setter
    def Y(self, value: Vector4) -> Vector4: ...
    @property
    def Z(self) -> Vector4: ...
    @Z.setter
    def Z(self, value: Vector4) -> Vector4: ...
    @staticmethod
    ...
    @staticmethod
    def CreateBillboardLeftHanded(objectPosition: Vector3, cameraPosition: Vector3, cameraUpVector: Vector3, cameraForwardVector: Vector3) -> Matrix4x4: ...
    @staticmethod
    ...
    @staticmethod
    def CreateConstrainedBillboardLeftHanded(objectPosition: Vector3, cameraPosition: Vector3, rotateAxis: Vector3, cameraForwardVector: Vector3, objectForwardVector: Vector3) -> Matrix4x4: ...
    @staticmethod
    ...
    def WithElement(self, row: int, column: int, value: float) -> Matrix4x4: ...
    def WithRow(self, index: int, value: Vector4) -> Matrix4x4: ...
    # Skipped Create due to it being static, abstract and generic.

    Create : Create_MethodGroup
    class Create_MethodGroup:
        @typing.overload
        def __call__(self, value: float) -> Matrix4x4:...
        @typing.overload
        def __call__(self, value: Matrix3x2) -> Matrix4x4:...
        @typing.overload
        def __call__(self, value: Vector4) -> Matrix4x4:...
        @typing.overload
        def __call__(self, x: Vector4, y: Vector4, z: Vector4, w: Vector4) -> Matrix4x4:...
        @typing.overload
        def __call__(self, m11: float, m12: float, m13: float, m14: float, m21: float, m22: float, m23: float, m24: float, m31: float, m32: float, m33: float, m34: float, m41: float, m42: float, m43: float, m44: float) -> Matrix4x4:...
    ...
    def __getitem__(self, row: int) -> Vector4: ...
    def __setitem__(self, row: int, value: Vector4) -> None: ...
    def __getitem__(self, row: int, column: int) -> float: ...
    def __setitem__(self, row: int, column: int, value: float) -> None: ...
...
class Plane(IEquatable_1[Plane]):
    ...
    class Create_MethodGroup:
        @typing.overload
        def __call__(self, value: Vector4) -> Plane:...
        @typing.overload
        def __call__(self, normal: Vector3, d: float) -> Plane:...
        @typing.overload
        def __call__(self, x: float, y: float, z: float, d: float) -> Plane:...
...
class Quaternion(IEquatable_1[Quaternion]):
    ...
    class Create_MethodGroup:
        @typing.overload
        def __call__(self, vectorPart: Vector3, scalarPart: float) -> Quaternion:...
        @typing.overload
        def __call__(self, x: float, y: float, z: float, w: float) -> Quaternion:...
...
class Vector_0(abc.ABC):
    ...
    @staticmethod
    def AsPlane(value: Vector4) -> Plane: ...
    @staticmethod
    def AsQuaternion(value: Vector4) -> Quaternion: ...
    @staticmethod
    def AsVector3Unsafe(value: Vector2) -> Vector3: ...
    @staticmethod
    def ConvertToInt32(value: Vector_1[float]) -> Vector_1[int]: ...
    @staticmethod
    def ConvertToInt32Native(value: Vector_1[float]) -> Vector_1[int]: ...
    @staticmethod
    def ConvertToInt64(value: Vector_1[float]) -> Vector_1[int]: ...
    @staticmethod
    def ConvertToInt64Native(value: Vector_1[float]) -> Vector_1[int]: ...
    @staticmethod
    def ConvertToUInt32(value: Vector_1[float]) -> Vector_1[int]: ...
    @staticmethod
    def ConvertToUInt32Native(value: Vector_1[float]) -> Vector_1[int]: ...
    @staticmethod
    def ConvertToUInt64(value: Vector_1[float]) -> Vector_1[int]: ...
    @staticmethod
    def ConvertToUInt64Native(value: Vector_1[float]) -> Vector_1[int]: ...
    ...
    class AddSaturate_MethodGroup:
        ...
        class AddSaturate_1(typing.Generic[AddSaturate_1_T1]):
            AddSaturate_1_T = Vector_0.AddSaturate_MethodGroup.AddSaturate_1_T1
            def __call__(self, left: Vector_1[AddSaturate_1_T], right: Vector_1[AddSaturate_1_T]) -> Vector_1[AddSaturate_1_T]:...
    ...
    class All_MethodGroup:
        ...
        class All_1(typing.Generic[All_1_T1]):
            All_1_T = Vector_0.All_MethodGroup.All_1_T1
            def __call__(self, vector: Vector_1[All_1_T], value: All_1_T) -> bool:...
    ...
    class AllWhereAllBitsSet_MethodGroup:
        ...
        class AllWhereAllBitsSet_1(typing.Generic[AllWhereAllBitsSet_1_T1]):
            AllWhereAllBitsSet_1_T = Vector_0.AllWhereAllBitsSet_MethodGroup.AllWhereAllBitsSet_1_T1
            def __call__(self, vector: Vector_1[AllWhereAllBitsSet_1_T]) -> bool:...
    ...
    class Any_MethodGroup:
        ...
        class Any_1(typing.Generic[Any_1_T1]):
            Any_1_T = Vector_0.Any_MethodGroup.Any_1_T1
            def __call__(self, vector: Vector_1[Any_1_T], value: Any_1_T) -> bool:...
    ...
    class AnyWhereAllBitsSet_MethodGroup:
        ...
        class AnyWhereAllBitsSet_1(typing.Generic[AnyWhereAllBitsSet_1_T1]):
            AnyWhereAllBitsSet_1_T = Vector_0.AnyWhereAllBitsSet_MethodGroup.AnyWhereAllBitsSet_1_T1
            def __call__(self, vector: Vector_1[AnyWhereAllBitsSet_1_T]) -> bool:...
    ...
    # Skipped AsVector2 due to it being static, abstract and generic.

    AsVector2 : AsVector2_MethodGroup
    class AsVector2_MethodGroup:
        @typing.overload
        def __call__(self, value: Vector3) -> Vector2:...
        @typing.overload
        def __call__(self, value: Vector4) -> Vector2:...

    # Skipped AsVector3 due to it being static, abstract and generic.

    AsVector3 : AsVector3_MethodGroup
    class AsVector3_MethodGroup:
        @typing.overload
        def __call__(self, value: Vector2) -> Vector3:...
        @typing.overload
        def __call__(self, value: Vector4) -> Vector3:...

    # Skipped AsVector4 due to it being static, abstract and generic.

    AsVector4 : AsVector4_MethodGroup
    class AsVector4_MethodGroup:
        @typing.overload
        def __call__(self, value: Plane) -> Vector4:...
        @typing.overload
        def __call__(self, value: Quaternion) -> Vector4:...
        @typing.overload
        def __call__(self, value: Vector2) -> Vector4:...
        @typing.overload
        def __call__(self, value: Vector3) -> Vector4:...

    # Skipped AsVector4Unsafe due to it being static, abstract and generic.

    AsVector4Unsafe : AsVector4Unsafe_MethodGroup
    class AsVector4Unsafe_MethodGroup:
        @typing.overload
        def __call__(self, value: Vector2) -> Vector4:...
        @typing.overload
        def __call__(self, value: Vector3) -> Vector4:...
    ...
    class Clamp_MethodGroup:
        ...
        class Clamp_1(typing.Generic[Clamp_1_T1]):
            Clamp_1_T = Vector_0.Clamp_MethodGroup.Clamp_1_T1
            def __call__(self, value: Vector_1[Clamp_1_T], min: Vector_1[Clamp_1_T], max: Vector_1[Clamp_1_T]) -> Vector_1[Clamp_1_T]:...
    ...
    class ClampNative_MethodGroup:
        ...
        class ClampNative_1(typing.Generic[ClampNative_1_T1]):
            ClampNative_1_T = Vector_0.ClampNative_MethodGroup.ClampNative_1_T1
            def __call__(self, value: Vector_1[ClampNative_1_T], min: Vector_1[ClampNative_1_T], max: Vector_1[ClampNative_1_T]) -> Vector_1[ClampNative_1_T]:...
    ...
    class CopySign_MethodGroup:
        ...
        class CopySign_1(typing.Generic[CopySign_1_T1]):
            CopySign_1_T = Vector_0.CopySign_MethodGroup.CopySign_1_T1
            def __call__(self, value: Vector_1[CopySign_1_T], sign: Vector_1[CopySign_1_T]) -> Vector_1[CopySign_1_T]:...
    ...
    class Cos_MethodGroup:
        def __call__(self, vector: Vector_1[float]) -> Vector_1[float]:...
        # Method Cos(vector : Vector`1) was skipped since it collides with above method
    ...
    class Count_MethodGroup:
        ...
        class Count_1(typing.Generic[Count_1_T1]):
            Count_1_T = Vector_0.Count_MethodGroup.Count_1_T1
            def __call__(self, vector: Vector_1[Count_1_T], value: Count_1_T) -> int:...
    ...
    class CountWhereAllBitsSet_MethodGroup:
        ...
        class CountWhereAllBitsSet_1(typing.Generic[CountWhereAllBitsSet_1_T1]):
            CountWhereAllBitsSet_1_T = Vector_0.CountWhereAllBitsSet_MethodGroup.CountWhereAllBitsSet_1_T1
            def __call__(self, vector: Vector_1[CountWhereAllBitsSet_1_T]) -> int:...
    ...
    class Create_MethodGroup:
        ...
        class Create_1(typing.Generic[Create_1_T1]):
            Create_1_T = Vector_0.Create_MethodGroup.Create_1_T1
            @typing.overload
            def __call__(self, values: ReadOnlySpan_1[Create_1_T]) -> Vector_1[Create_1_T]:...
            @typing.overload
            def __call__(self, value: Create_1_T) -> Vector_1[Create_1_T]:...
    ...
    class CreateScalar_MethodGroup:
        ...
        class CreateScalar_1(typing.Generic[CreateScalar_1_T1]):
            CreateScalar_1_T = Vector_0.CreateScalar_MethodGroup.CreateScalar_1_T1
            def __call__(self, value: CreateScalar_1_T) -> Vector_1[CreateScalar_1_T]:...
    ...
    class CreateScalarUnsafe_MethodGroup:
        ...
        class CreateScalarUnsafe_1(typing.Generic[CreateScalarUnsafe_1_T1]):
            CreateScalarUnsafe_1_T = Vector_0.CreateScalarUnsafe_MethodGroup.CreateScalarUnsafe_1_T1
            def __call__(self, value: CreateScalarUnsafe_1_T) -> Vector_1[CreateScalarUnsafe_1_T]:...
    ...
    class CreateSequence_MethodGroup:
        ...
        class CreateSequence_1(typing.Generic[CreateSequence_1_T1]):
            CreateSequence_1_T = Vector_0.CreateSequence_MethodGroup.CreateSequence_1_T1
            def __call__(self, start: CreateSequence_1_T, step: CreateSequence_1_T) -> Vector_1[CreateSequence_1_T]:...
    ...
    class DegreesToRadians_MethodGroup:
        def __call__(self, degrees: Vector_1[float]) -> Vector_1[float]:...
        # Method DegreesToRadians(degrees : Vector`1) was skipped since it collides with above method
    ...
    class Exp_MethodGroup:
        def __call__(self, vector: Vector_1[float]) -> Vector_1[float]:...
        # Method Exp(vector : Vector`1) was skipped since it collides with above method
    ...
    class ExtractMostSignificantBits_MethodGroup:
        @typing.overload
        def __call__(self, vector: Vector2) -> int:...
        @typing.overload
        def __call__(self, vector: Vector3) -> int:...
        @typing.overload
        def __call__(self, vector: Vector4) -> int:...
    ...
    class FusedMultiplyAdd_MethodGroup:
        def __call__(self, left: Vector_1[float], right: Vector_1[float], addend: Vector_1[float]) -> Vector_1[float]:...
        # Method FusedMultiplyAdd(left : Vector`1, right : Vector`1, addend : Vector`1) was skipped since it collides with above method
    ...
    class GetElement_MethodGroup:
        ...
        @typing.overload
        def __call__(self, vector: Vector2, index: int) -> float:...
        @typing.overload
        def __call__(self, vector: Vector3, index: int) -> float:...
        @typing.overload
        def __call__(self, vector: Vector4, index: int) -> float:...
    ...
    class Hypot_MethodGroup:
        def __call__(self, x: Vector_1[float], y: Vector_1[float]) -> Vector_1[float]:...
        # Method Hypot(x : Vector`1, y : Vector`1) was skipped since it collides with above method
    ...
    class IndexOf_MethodGroup:
        ...
        class IndexOf_1(typing.Generic[IndexOf_1_T1]):
            IndexOf_1_T = Vector_0.IndexOf_MethodGroup.IndexOf_1_T1
            def __call__(self, vector: Vector_1[IndexOf_1_T], value: IndexOf_1_T) -> int:...
    ...
    class IndexOfWhereAllBitsSet_MethodGroup:
        ...
        class IndexOfWhereAllBitsSet_1(typing.Generic[IndexOfWhereAllBitsSet_1_T1]):
            IndexOfWhereAllBitsSet_1_T = Vector_0.IndexOfWhereAllBitsSet_MethodGroup.IndexOfWhereAllBitsSet_1_T1
            def __call__(self, vector: Vector_1[IndexOfWhereAllBitsSet_1_T]) -> int:...
    ...
    class IsEvenInteger_MethodGroup:
        ...
        class IsEvenInteger_1(typing.Generic[IsEvenInteger_1_T1]):
            IsEvenInteger_1_T = Vector_0.IsEvenInteger_MethodGroup.IsEvenInteger_1_T1
            def __call__(self, vector: Vector_1[IsEvenInteger_1_T]) -> Vector_1[IsEvenInteger_1_T]:...
    ...
    class IsFinite_MethodGroup:
        ...
        class IsFinite_1(typing.Generic[IsFinite_1_T1]):
            IsFinite_1_T = Vector_0.IsFinite_MethodGroup.IsFinite_1_T1
            def __call__(self, vector: Vector_1[IsFinite_1_T]) -> Vector_1[IsFinite_1_T]:...
    ...
    class IsInfinity_MethodGroup:
        ...
        class IsInfinity_1(typing.Generic[IsInfinity_1_T1]):
            IsInfinity_1_T = Vector_0.IsInfinity_MethodGroup.IsInfinity_1_T1
            def __call__(self, vector: Vector_1[IsInfinity_1_T]) -> Vector_1[IsInfinity_1_T]:...
    ...
    class IsInteger_MethodGroup:
        ...
        class IsInteger_1(typing.Generic[IsInteger_1_T1]):
            IsInteger_1_T = Vector_0.IsInteger_MethodGroup.IsInteger_1_T1
            def __call__(self, vector: Vector_1[IsInteger_1_T]) -> Vector_1[IsInteger_1_T]:...
    ...
    class IsNaN_MethodGroup:
        ...
        class IsNaN_1(typing.Generic[IsNaN_1_T1]):
            IsNaN_1_T = Vector_0.IsNaN_MethodGroup.IsNaN_1_T1
            def __call__(self, vector: Vector_1[IsNaN_1_T]) -> Vector_1[IsNaN_1_T]:...
    ...
    class IsNegative_MethodGroup:
        ...
        class IsNegative_1(typing.Generic[IsNegative_1_T1]):
            IsNegative_1_T = Vector_0.IsNegative_MethodGroup.IsNegative_1_T1
            def __call__(self, vector: Vector_1[IsNegative_1_T]) -> Vector_1[IsNegative_1_T]:...
    ...
    class IsNegativeInfinity_MethodGroup:
        ...
        class IsNegativeInfinity_1(typing.Generic[IsNegativeInfinity_1_T1]):
            IsNegativeInfinity_1_T = Vector_0.IsNegativeInfinity_MethodGroup.IsNegativeInfinity_1_T1
            def __call__(self, vector: Vector_1[IsNegativeInfinity_1_T]) -> Vector_1[IsNegativeInfinity_1_T]:...
    ...
    class IsNormal_MethodGroup:
        ...
        class IsNormal_1(typing.Generic[IsNormal_1_T1]):
            IsNormal_1_T = Vector_0.IsNormal_MethodGroup.IsNormal_1_T1
            def __call__(self, vector: Vector_1[IsNormal_1_T]) -> Vector_1[IsNormal_1_T]:...
    ...
    class IsOddInteger_MethodGroup:
        ...
        class IsOddInteger_1(typing.Generic[IsOddInteger_1_T1]):
            IsOddInteger_1_T = Vector_0.IsOddInteger_MethodGroup.IsOddInteger_1_T1
            def __call__(self, vector: Vector_1[IsOddInteger_1_T]) -> Vector_1[IsOddInteger_1_T]:...
    ...
    class IsPositive_MethodGroup:
        ...
        class IsPositive_1(typing.Generic[IsPositive_1_T1]):
            IsPositive_1_T = Vector_0.IsPositive_MethodGroup.IsPositive_1_T1
            def __call__(self, vector: Vector_1[IsPositive_1_T]) -> Vector_1[IsPositive_1_T]:...
    ...
    class IsPositiveInfinity_MethodGroup:
        ...
        class IsPositiveInfinity_1(typing.Generic[IsPositiveInfinity_1_T1]):
            IsPositiveInfinity_1_T = Vector_0.IsPositiveInfinity_MethodGroup.IsPositiveInfinity_1_T1
            def __call__(self, vector: Vector_1[IsPositiveInfinity_1_T]) -> Vector_1[IsPositiveInfinity_1_T]:...
    ...
    class IsSubnormal_MethodGroup:
        ...
        class IsSubnormal_1(typing.Generic[IsSubnormal_1_T1]):
            IsSubnormal_1_T = Vector_0.IsSubnormal_MethodGroup.IsSubnormal_1_T1
            def __call__(self, vector: Vector_1[IsSubnormal_1_T]) -> Vector_1[IsSubnormal_1_T]:...
    ...
    class IsZero_MethodGroup:
        ...
        class IsZero_1(typing.Generic[IsZero_1_T1]):
            IsZero_1_T = Vector_0.IsZero_MethodGroup.IsZero_1_T1
            def __call__(self, vector: Vector_1[IsZero_1_T]) -> Vector_1[IsZero_1_T]:...
    ...
    class LastIndexOf_MethodGroup:
        ...
        class LastIndexOf_1(typing.Generic[LastIndexOf_1_T1]):
            LastIndexOf_1_T = Vector_0.LastIndexOf_MethodGroup.LastIndexOf_1_T1
            def __call__(self, vector: Vector_1[LastIndexOf_1_T], value: LastIndexOf_1_T) -> int:...
    ...
    class LastIndexOfWhereAllBitsSet_MethodGroup:
        ...
        class LastIndexOfWhereAllBitsSet_1(typing.Generic[LastIndexOfWhereAllBitsSet_1_T1]):
            LastIndexOfWhereAllBitsSet_1_T = Vector_0.LastIndexOfWhereAllBitsSet_MethodGroup.LastIndexOfWhereAllBitsSet_1_T1
            def __call__(self, vector: Vector_1[LastIndexOfWhereAllBitsSet_1_T]) -> int:...
    ...
    class Lerp_MethodGroup:
        def __call__(self, x: Vector_1[float], y: Vector_1[float], amount: Vector_1[float]) -> Vector_1[float]:...
        # Method Lerp(x : Vector`1, y : Vector`1, amount : Vector`1) was skipped since it collides with above method
    ...
    class Log_MethodGroup:
        def __call__(self, vector: Vector_1[float]) -> Vector_1[float]:...
        # Method Log(vector : Vector`1) was skipped since it collides with above method
    ...
    class Log2_MethodGroup:
        def __call__(self, vector: Vector_1[float]) -> Vector_1[float]:...
        # Method Log2(vector : Vector`1) was skipped since it collides with above method
    ...
    class MaxMagnitude_MethodGroup:
        ...
        class MaxMagnitude_1(typing.Generic[MaxMagnitude_1_T1]):
            MaxMagnitude_1_T = Vector_0.MaxMagnitude_MethodGroup.MaxMagnitude_1_T1
            def __call__(self, left: Vector_1[MaxMagnitude_1_T], right: Vector_1[MaxMagnitude_1_T]) -> Vector_1[MaxMagnitude_1_T]:...
    ...
    class MaxMagnitudeNumber_MethodGroup:
        ...
        class MaxMagnitudeNumber_1(typing.Generic[MaxMagnitudeNumber_1_T1]):
            MaxMagnitudeNumber_1_T = Vector_0.MaxMagnitudeNumber_MethodGroup.MaxMagnitudeNumber_1_T1
            def __call__(self, left: Vector_1[MaxMagnitudeNumber_1_T], right: Vector_1[MaxMagnitudeNumber_1_T]) -> Vector_1[MaxMagnitudeNumber_1_T]:...
    ...
    class MaxNative_MethodGroup:
        ...
        class MaxNative_1(typing.Generic[MaxNative_1_T1]):
            MaxNative_1_T = Vector_0.MaxNative_MethodGroup.MaxNative_1_T1
            def __call__(self, left: Vector_1[MaxNative_1_T], right: Vector_1[MaxNative_1_T]) -> Vector_1[MaxNative_1_T]:...
    ...
    class MaxNumber_MethodGroup:
        ...
        class MaxNumber_1(typing.Generic[MaxNumber_1_T1]):
            MaxNumber_1_T = Vector_0.MaxNumber_MethodGroup.MaxNumber_1_T1
            def __call__(self, left: Vector_1[MaxNumber_1_T], right: Vector_1[MaxNumber_1_T]) -> Vector_1[MaxNumber_1_T]:...
    ...
    class MinMagnitude_MethodGroup:
        ...
        class MinMagnitude_1(typing.Generic[MinMagnitude_1_T1]):
            MinMagnitude_1_T = Vector_0.MinMagnitude_MethodGroup.MinMagnitude_1_T1
            def __call__(self, left: Vector_1[MinMagnitude_1_T], right: Vector_1[MinMagnitude_1_T]) -> Vector_1[MinMagnitude_1_T]:...
    ...
    class MinMagnitudeNumber_MethodGroup:
        ...
        class MinMagnitudeNumber_1(typing.Generic[MinMagnitudeNumber_1_T1]):
            MinMagnitudeNumber_1_T = Vector_0.MinMagnitudeNumber_MethodGroup.MinMagnitudeNumber_1_T1
            def __call__(self, left: Vector_1[MinMagnitudeNumber_1_T], right: Vector_1[MinMagnitudeNumber_1_T]) -> Vector_1[MinMagnitudeNumber_1_T]:...
    ...
    class MinNative_MethodGroup:
        ...
        class MinNative_1(typing.Generic[MinNative_1_T1]):
            MinNative_1_T = Vector_0.MinNative_MethodGroup.MinNative_1_T1
            def __call__(self, left: Vector_1[MinNative_1_T], right: Vector_1[MinNative_1_T]) -> Vector_1[MinNative_1_T]:...
    ...
    class MinNumber_MethodGroup:
        ...
        class MinNumber_1(typing.Generic[MinNumber_1_T1]):
            MinNumber_1_T = Vector_0.MinNumber_MethodGroup.MinNumber_1_T1
            def __call__(self, left: Vector_1[MinNumber_1_T], right: Vector_1[MinNumber_1_T]) -> Vector_1[MinNumber_1_T]:...
    ...
    class MultiplyAddEstimate_MethodGroup:
        def __call__(self, left: Vector_1[float], right: Vector_1[float], addend: Vector_1[float]) -> Vector_1[float]:...
        # Method MultiplyAddEstimate(left : Vector`1, right : Vector`1, addend : Vector`1) was skipped since it collides with above method
    ...
    class NarrowWithSaturation_MethodGroup:
        def __call__(self, low: Vector_1[float], high: Vector_1[float]) -> Vector_1[float]:...
        # Method NarrowWithSaturation(low : Vector`1, high : Vector`1) was skipped since it collides with above method
        # Method NarrowWithSaturation(low : Vector`1, high : Vector`1) was skipped since it collides with above method
        # Method NarrowWithSaturation(low : Vector`1, high : Vector`1) was skipped since it collides with above method
        # Method NarrowWithSaturation(low : Vector`1, high : Vector`1) was skipped since it collides with above method
        # Method NarrowWithSaturation(low : Vector`1, high : Vector`1) was skipped since it collides with above method
    ...
    class None_MethodGroup:
        ...
        class None_1(typing.Generic[None_1_T1]):
            None_1_T = Vector_0.None_MethodGroup.None_1_T1
            def __call__(self, vector: Vector_1[None_1_T], value: None_1_T) -> bool:...
    ...
    class NoneWhereAllBitsSet_MethodGroup:
        ...
        class NoneWhereAllBitsSet_1(typing.Generic[NoneWhereAllBitsSet_1_T1]):
            NoneWhereAllBitsSet_1_T = Vector_0.NoneWhereAllBitsSet_MethodGroup.NoneWhereAllBitsSet_1_T1
            def __call__(self, vector: Vector_1[NoneWhereAllBitsSet_1_T]) -> bool:...
    ...
    class RadiansToDegrees_MethodGroup:
        def __call__(self, radians: Vector_1[float]) -> Vector_1[float]:...
        # Method RadiansToDegrees(radians : Vector`1) was skipped since it collides with above method
    ...
    class Round_MethodGroup:
        @typing.overload
        def __call__(self, vector: Vector_1[float]) -> Vector_1[float]:...
        # Method Round(vector : Vector`1) was skipped since it collides with above method
        @typing.overload
        def __call__(self, vector: Vector_1[float], mode: MidpointRounding) -> Vector_1[float]:...
        # Method Round(vector : Vector`1, mode : MidpointRounding) was skipped since it collides with above method
    ...
    class Sin_MethodGroup:
        def __call__(self, vector: Vector_1[float]) -> Vector_1[float]:...
        # Method Sin(vector : Vector`1) was skipped since it collides with above method

    # Skipped SinCos due to it being static, abstract and generic.

    SinCos : SinCos_MethodGroup
    class SinCos_MethodGroup:
        def __call__(self, vector: Vector_1[float]) -> ValueTuple_2[Vector_1[float], Vector_1[float]]:...
        # Method SinCos(vector : Vector`1) was skipped since it collides with above method
    ...
    class Store_MethodGroup:
        ...
        @typing.overload
        def __call__(self, source: Vector2, destination: clr.Reference[float]) -> None:...
        @typing.overload
        def __call__(self, source: Vector3, destination: clr.Reference[float]) -> None:...
        @typing.overload
        def __call__(self, source: Vector4, destination: clr.Reference[float]) -> None:...
    ...
    class StoreUnsafe_MethodGroup:
        ...
        def __call__(self, source: Vector4, destination: clr.Reference[float]) -> None:...
        @typing.overload
        def __call__(self, source: Vector2, destination: clr.Reference[float], elementOffset: UIntPtr) -> None:...
        @typing.overload
        def __call__(self, source: Vector3, destination: clr.Reference[float], elementOffset: UIntPtr) -> None:...
        @typing.overload
        def __call__(self, source: Vector4, destination: clr.Reference[float], elementOffset: UIntPtr) -> None:...
    ...
    class SubtractSaturate_MethodGroup:
        ...
        class SubtractSaturate_1(typing.Generic[SubtractSaturate_1_T1]):
            SubtractSaturate_1_T = Vector_0.SubtractSaturate_MethodGroup.SubtractSaturate_1_T1
            def __call__(self, left: Vector_1[SubtractSaturate_1_T], right: Vector_1[SubtractSaturate_1_T]) -> Vector_1[SubtractSaturate_1_T]:...
    ...
    class ToScalar_MethodGroup:
        ...
        @typing.overload
        def __call__(self, vector: Vector2) -> float:...
        @typing.overload
        def __call__(self, vector: Vector3) -> float:...
        @typing.overload
        def __call__(self, vector: Vector4) -> float:...
    ...
    class Truncate_MethodGroup:
        def __call__(self, vector: Vector_1[float]) -> Vector_1[float]:...
        # Method Truncate(vector : Vector`1) was skipped since it collides with above method
    ...
    class WithElement_MethodGroup:
        ...
        @typing.overload
        def __call__(self, vector: Vector2, index: int, value: float) -> Vector2:...
        @typing.overload
        def __call__(self, vector: Vector3, index: int, value: float) -> Vector3:...
        @typing.overload
        def __call__(self, vector: Vector4, index: int, value: float) -> Vector4:...
...
class Vector_1(typing.Generic[Vector_1_T], IFormattable):
    @typing.overload
    ...
    @classmethod
    @property
    def Indices(cls) -> Vector_1[Vector_1_T]: ...
    @classmethod
    @property
    ...
    def __getitem__(self, index: int) -> Vector_1_T: ...
...
class Vector2(IFormattable, IEquatable_1[Vector2]):
    ...
    @classmethod
    @property
    def AllBitsSet(cls) -> Vector2: ...
    @classmethod
    @property
    def E(cls) -> Vector2: ...
    @classmethod
    @property
    def Epsilon(cls) -> Vector2: ...
    @classmethod
    @property
    def NaN(cls) -> Vector2: ...
    @classmethod
    ...
    @staticmethod
    def All(vector: Vector2, value: float) -> bool: ...
    @staticmethod
    def AllWhereAllBitsSet(vector: Vector2) -> bool: ...
    @staticmethod
    def AndNot(left: Vector2, right: Vector2) -> Vector2: ...
    @staticmethod
    def Any(vector: Vector2, value: float) -> bool: ...
    @staticmethod
    def AnyWhereAllBitsSet(vector: Vector2) -> bool: ...
    @staticmethod
    def BitwiseAnd(left: Vector2, right: Vector2) -> Vector2: ...
    @staticmethod
    def BitwiseOr(left: Vector2, right: Vector2) -> Vector2: ...
    @staticmethod
    def Clamp(value1: Vector2, min: Vector2, max: Vector2) -> Vector2: ...
    @staticmethod
    def ClampNative(value1: Vector2, min: Vector2, max: Vector2) -> Vector2: ...
    @staticmethod
    def ConditionalSelect(condition: Vector2, left: Vector2, right: Vector2) -> Vector2: ...
    @staticmethod
    def CopySign(value: Vector2, sign: Vector2) -> Vector2: ...
    @staticmethod
    def Cos(vector: Vector2) -> Vector2: ...
    @staticmethod
    def Count(vector: Vector2, value: float) -> int: ...
    @staticmethod
    def CountWhereAllBitsSet(vector: Vector2) -> int: ...
    @staticmethod
    def CreateScalar(x: float) -> Vector2: ...
    @staticmethod
    def CreateScalarUnsafe(x: float) -> Vector2: ...
    @staticmethod
    def Cross(value1: Vector2, value2: Vector2) -> float: ...
    @staticmethod
    def DegreesToRadians(degrees: Vector2) -> Vector2: ...
    @staticmethod
    ...
    @staticmethod
    def EqualsAll(left: Vector2, right: Vector2) -> bool: ...
    @staticmethod
    def EqualsAny(left: Vector2, right: Vector2) -> bool: ...
    @staticmethod
    def Exp(vector: Vector2) -> Vector2: ...
    @staticmethod
    def FusedMultiplyAdd(left: Vector2, right: Vector2, addend: Vector2) -> Vector2: ...
    def GetHashCode(self) -> int: ...
    @staticmethod
    def GreaterThan(left: Vector2, right: Vector2) -> Vector2: ...
    @staticmethod
    def GreaterThanAll(left: Vector2, right: Vector2) -> bool: ...
    @staticmethod
    def GreaterThanAny(left: Vector2, right: Vector2) -> bool: ...
    @staticmethod
    def GreaterThanOrEqual(left: Vector2, right: Vector2) -> Vector2: ...
    @staticmethod
    def GreaterThanOrEqualAll(left: Vector2, right: Vector2) -> bool: ...
    @staticmethod
    def GreaterThanOrEqualAny(left: Vector2, right: Vector2) -> bool: ...
    @staticmethod
    def Hypot(x: Vector2, y: Vector2) -> Vector2: ...
    @staticmethod
    def IndexOf(vector: Vector2, value: float) -> int: ...
    @staticmethod
    def IndexOfWhereAllBitsSet(vector: Vector2) -> int: ...
    @staticmethod
    def IsEvenInteger(vector: Vector2) -> Vector2: ...
    @staticmethod
    def IsFinite(vector: Vector2) -> Vector2: ...
    @staticmethod
    def IsInfinity(vector: Vector2) -> Vector2: ...
    @staticmethod
    def IsInteger(vector: Vector2) -> Vector2: ...
    @staticmethod
    def IsNaN(vector: Vector2) -> Vector2: ...
    @staticmethod
    def IsNegative(vector: Vector2) -> Vector2: ...
    @staticmethod
    def IsNegativeInfinity(vector: Vector2) -> Vector2: ...
    @staticmethod
    def IsNormal(vector: Vector2) -> Vector2: ...
    @staticmethod
    def IsOddInteger(vector: Vector2) -> Vector2: ...
    @staticmethod
    def IsPositive(vector: Vector2) -> Vector2: ...
    @staticmethod
    def IsPositiveInfinity(vector: Vector2) -> Vector2: ...
    @staticmethod
    def IsSubnormal(vector: Vector2) -> Vector2: ...
    @staticmethod
    def IsZero(vector: Vector2) -> Vector2: ...
    @staticmethod
    def LastIndexOf(vector: Vector2, value: float) -> int: ...
    @staticmethod
    def LastIndexOfWhereAllBitsSet(vector: Vector2) -> int: ...
    def Length(self) -> float: ...
    def LengthSquared(self) -> float: ...
    @staticmethod
    def LessThan(left: Vector2, right: Vector2) -> Vector2: ...
    @staticmethod
    def LessThanAll(left: Vector2, right: Vector2) -> bool: ...
    @staticmethod
    def LessThanAny(left: Vector2, right: Vector2) -> bool: ...
    @staticmethod
    def LessThanOrEqual(left: Vector2, right: Vector2) -> Vector2: ...
    @staticmethod
    def LessThanOrEqualAll(left: Vector2, right: Vector2) -> bool: ...
    @staticmethod
    def LessThanOrEqualAny(left: Vector2, right: Vector2) -> bool: ...
    @staticmethod
    def Load(source: clr.Reference[float]) -> Vector2: ...
    @staticmethod
    def LoadAligned(source: clr.Reference[float]) -> Vector2: ...
    @staticmethod
    def LoadAlignedNonTemporal(source: clr.Reference[float]) -> Vector2: ...
    @staticmethod
    def Log(vector: Vector2) -> Vector2: ...
    @staticmethod
    def Log2(vector: Vector2) -> Vector2: ...
    @staticmethod
    def Max(value1: Vector2, value2: Vector2) -> Vector2: ...
    @staticmethod
    def MaxMagnitude(value1: Vector2, value2: Vector2) -> Vector2: ...
    @staticmethod
    def MaxMagnitudeNumber(value1: Vector2, value2: Vector2) -> Vector2: ...
    @staticmethod
    def MaxNative(value1: Vector2, value2: Vector2) -> Vector2: ...
    @staticmethod
    def MaxNumber(value1: Vector2, value2: Vector2) -> Vector2: ...
    @staticmethod
    def Min(value1: Vector2, value2: Vector2) -> Vector2: ...
    @staticmethod
    def MinMagnitude(value1: Vector2, value2: Vector2) -> Vector2: ...
    @staticmethod
    def MinMagnitudeNumber(value1: Vector2, value2: Vector2) -> Vector2: ...
    @staticmethod
    def MinNative(value1: Vector2, value2: Vector2) -> Vector2: ...
    @staticmethod
    def MinNumber(value1: Vector2, value2: Vector2) -> Vector2: ...
    @staticmethod
    def MultiplyAddEstimate(left: Vector2, right: Vector2, addend: Vector2) -> Vector2: ...
    @staticmethod
    def Negate(value: Vector2) -> Vector2: ...
    @staticmethod
    def None(vector: Vector2, value: float) -> bool: ...
    @staticmethod
    def NoneWhereAllBitsSet(vector: Vector2) -> bool: ...
    @staticmethod
    def Normalize(value: Vector2) -> Vector2: ...
    @staticmethod
    def OnesComplement(value: Vector2) -> Vector2: ...
    def __add__(self, left: Vector2, right: Vector2) -> Vector2: ...
    def __and__(self, left: Vector2, right: Vector2) -> Vector2: ...
    def __or__(self, left: Vector2, right: Vector2) -> Vector2: ...
    @typing.overload
    ...
    def __xor__(self, left: Vector2, right: Vector2) -> Vector2: ...
    def __ne__(self, left: Vector2, right: Vector2) -> bool: ...
    def __lshift__(self, value: Vector2, shiftAmount: int) -> Vector2: ...
    @typing.overload
    ...
    def __invert__(self, value: Vector2) -> Vector2: ...
    def __rshift__(self, value: Vector2, shiftAmount: int) -> Vector2: ...
    def __sub__(self, left: Vector2, right: Vector2) -> Vector2: ...
    def __neg__(self, value: Vector2) -> Vector2: ...
    def __pos__(self, value: Vector2) -> Vector2: ...
    # Operator not supported op_UnsignedRightShift(value: Vector2, shiftAmount: Int32)
    @staticmethod
    def RadiansToDegrees(radians: Vector2) -> Vector2: ...
    @staticmethod
    def Reflect(vector: Vector2, normal: Vector2) -> Vector2: ...
    @staticmethod
    def Shuffle(vector: Vector2, xIndex: int, yIndex: int) -> Vector2: ...
    @staticmethod
    def Sin(vector: Vector2) -> Vector2: ...
    @staticmethod
    def SinCos(vector: Vector2) -> ValueTuple_2[Vector2, Vector2]: ...
    @staticmethod
    def SquareRoot(value: Vector2) -> Vector2: ...
    @staticmethod
    def Subtract(left: Vector2, right: Vector2) -> Vector2: ...
    @staticmethod
    def Sum(value: Vector2) -> float: ...
    @staticmethod
    def Truncate(vector: Vector2) -> Vector2: ...
    def TryCopyTo(self, destination: Span_1[float]) -> bool: ...
    @staticmethod
    def Xor(left: Vector2, right: Vector2) -> Vector2: ...
    # Skipped CopyTo due to it being static, abstract and generic.
    ...
    class Create_MethodGroup:
        @typing.overload
        def __call__(self, value: float) -> Vector2:...
        @typing.overload
        def __call__(self, values: ReadOnlySpan_1[float]) -> Vector2:...
        @typing.overload
        def __call__(self, x: float, y: float) -> Vector2:...
    ...
    class Lerp_MethodGroup:
        ...
        @typing.overload
        def __call__(self, value1: Vector2, value2: Vector2, amount: Vector2) -> Vector2:...
    ...
    class LoadUnsafe_MethodGroup:
        @typing.overload
        def __call__(self, source: clr.Reference[float]) -> Vector2:...
        @typing.overload
        def __call__(self, source: clr.Reference[float], elementOffset: UIntPtr) -> Vector2:...
    ...
    class Round_MethodGroup:
        @typing.overload
        def __call__(self, vector: Vector2) -> Vector2:...
        @typing.overload
        def __call__(self, vector: Vector2, mode: MidpointRounding) -> Vector2:...
...
class Vector3(IFormattable, IEquatable_1[Vector3]):
    ...
    @classmethod
    @property
    def AllBitsSet(cls) -> Vector3: ...
    @classmethod
    @property
    def E(cls) -> Vector3: ...
    @classmethod
    @property
    def Epsilon(cls) -> Vector3: ...
    @classmethod
    @property
    def NaN(cls) -> Vector3: ...
    @classmethod
    ...
    @staticmethod
    def All(vector: Vector3, value: float) -> bool: ...
    @staticmethod
    def AllWhereAllBitsSet(vector: Vector3) -> bool: ...
    @staticmethod
    def AndNot(left: Vector3, right: Vector3) -> Vector3: ...
    @staticmethod
    def Any(vector: Vector3, value: float) -> bool: ...
    @staticmethod
    def AnyWhereAllBitsSet(vector: Vector3) -> bool: ...
    @staticmethod
    def BitwiseAnd(left: Vector3, right: Vector3) -> Vector3: ...
    @staticmethod
    def BitwiseOr(left: Vector3, right: Vector3) -> Vector3: ...
    @staticmethod
    def Clamp(value1: Vector3, min: Vector3, max: Vector3) -> Vector3: ...
    @staticmethod
    def ClampNative(value1: Vector3, min: Vector3, max: Vector3) -> Vector3: ...
    @staticmethod
    def ConditionalSelect(condition: Vector3, left: Vector3, right: Vector3) -> Vector3: ...
    @staticmethod
    def CopySign(value: Vector3, sign: Vector3) -> Vector3: ...
    @staticmethod
    def Cos(vector: Vector3) -> Vector3: ...
    @staticmethod
    def Count(vector: Vector3, value: float) -> int: ...
    @staticmethod
    def CountWhereAllBitsSet(vector: Vector3) -> int: ...
    @staticmethod
    def CreateScalar(x: float) -> Vector3: ...
    @staticmethod
    def CreateScalarUnsafe(x: float) -> Vector3: ...
    @staticmethod
    def Cross(vector1: Vector3, vector2: Vector3) -> Vector3: ...
    @staticmethod
    def DegreesToRadians(degrees: Vector3) -> Vector3: ...
    @staticmethod
    ...
    @staticmethod
    def EqualsAll(left: Vector3, right: Vector3) -> bool: ...
    @staticmethod
    def EqualsAny(left: Vector3, right: Vector3) -> bool: ...
    @staticmethod
    def Exp(vector: Vector3) -> Vector3: ...
    @staticmethod
    def FusedMultiplyAdd(left: Vector3, right: Vector3, addend: Vector3) -> Vector3: ...
    def GetHashCode(self) -> int: ...
    @staticmethod
    def GreaterThan(left: Vector3, right: Vector3) -> Vector3: ...
    @staticmethod
    def GreaterThanAll(left: Vector3, right: Vector3) -> bool: ...
    @staticmethod
    def GreaterThanAny(left: Vector3, right: Vector3) -> bool: ...
    @staticmethod
    def GreaterThanOrEqual(left: Vector3, right: Vector3) -> Vector3: ...
    @staticmethod
    def GreaterThanOrEqualAll(left: Vector3, right: Vector3) -> bool: ...
    @staticmethod
    def GreaterThanOrEqualAny(left: Vector3, right: Vector3) -> bool: ...
    @staticmethod
    def Hypot(x: Vector3, y: Vector3) -> Vector3: ...
    @staticmethod
    def IndexOf(vector: Vector3, value: float) -> int: ...
    @staticmethod
    def IndexOfWhereAllBitsSet(vector: Vector3) -> int: ...
    @staticmethod
    def IsEvenInteger(vector: Vector3) -> Vector3: ...
    @staticmethod
    def IsFinite(vector: Vector3) -> Vector3: ...
    @staticmethod
    def IsInfinity(vector: Vector3) -> Vector3: ...
    @staticmethod
    def IsInteger(vector: Vector3) -> Vector3: ...
    @staticmethod
    def IsNaN(vector: Vector3) -> Vector3: ...
    @staticmethod
    def IsNegative(vector: Vector3) -> Vector3: ...
    @staticmethod
    def IsNegativeInfinity(vector: Vector3) -> Vector3: ...
    @staticmethod
    def IsNormal(vector: Vector3) -> Vector3: ...
    @staticmethod
    def IsOddInteger(vector: Vector3) -> Vector3: ...
    @staticmethod
    def IsPositive(vector: Vector3) -> Vector3: ...
    @staticmethod
    def IsPositiveInfinity(vector: Vector3) -> Vector3: ...
    @staticmethod
    def IsSubnormal(vector: Vector3) -> Vector3: ...
    @staticmethod
    def IsZero(vector: Vector3) -> Vector3: ...
    @staticmethod
    def LastIndexOf(vector: Vector3, value: float) -> int: ...
    @staticmethod
    def LastIndexOfWhereAllBitsSet(vector: Vector3) -> int: ...
    def Length(self) -> float: ...
    def LengthSquared(self) -> float: ...
    @staticmethod
    def LessThan(left: Vector3, right: Vector3) -> Vector3: ...
    @staticmethod
    def LessThanAll(left: Vector3, right: Vector3) -> bool: ...
    @staticmethod
    def LessThanAny(left: Vector3, right: Vector3) -> bool: ...
    @staticmethod
    def LessThanOrEqual(left: Vector3, right: Vector3) -> Vector3: ...
    @staticmethod
    def LessThanOrEqualAll(left: Vector3, right: Vector3) -> bool: ...
    @staticmethod
    def LessThanOrEqualAny(left: Vector3, right: Vector3) -> bool: ...
    @staticmethod
    def Load(source: clr.Reference[float]) -> Vector3: ...
    @staticmethod
    def LoadAligned(source: clr.Reference[float]) -> Vector3: ...
    @staticmethod
    def LoadAlignedNonTemporal(source: clr.Reference[float]) -> Vector3: ...
    @staticmethod
    def Log(vector: Vector3) -> Vector3: ...
    @staticmethod
    def Log2(vector: Vector3) -> Vector3: ...
    @staticmethod
    def Max(value1: Vector3, value2: Vector3) -> Vector3: ...
    @staticmethod
    def MaxMagnitude(value1: Vector3, value2: Vector3) -> Vector3: ...
    @staticmethod
    def MaxMagnitudeNumber(value1: Vector3, value2: Vector3) -> Vector3: ...
    @staticmethod
    def MaxNative(value1: Vector3, value2: Vector3) -> Vector3: ...
    @staticmethod
    def MaxNumber(value1: Vector3, value2: Vector3) -> Vector3: ...
    @staticmethod
    def Min(value1: Vector3, value2: Vector3) -> Vector3: ...
    @staticmethod
    def MinMagnitude(value1: Vector3, value2: Vector3) -> Vector3: ...
    @staticmethod
    def MinMagnitudeNumber(value1: Vector3, value2: Vector3) -> Vector3: ...
    @staticmethod
    def MinNative(value1: Vector3, value2: Vector3) -> Vector3: ...
    @staticmethod
    def MinNumber(value1: Vector3, value2: Vector3) -> Vector3: ...
    @staticmethod
    def MultiplyAddEstimate(left: Vector3, right: Vector3, addend: Vector3) -> Vector3: ...
    @staticmethod
    def Negate(value: Vector3) -> Vector3: ...
    @staticmethod
    def None(vector: Vector3, value: float) -> bool: ...
    @staticmethod
    def NoneWhereAllBitsSet(vector: Vector3) -> bool: ...
    @staticmethod
    def Normalize(value: Vector3) -> Vector3: ...
    @staticmethod
    def OnesComplement(value: Vector3) -> Vector3: ...
    def __add__(self, left: Vector3, right: Vector3) -> Vector3: ...
    def __and__(self, left: Vector3, right: Vector3) -> Vector3: ...
    def __or__(self, left: Vector3, right: Vector3) -> Vector3: ...
    @typing.overload
    ...
    def __xor__(self, left: Vector3, right: Vector3) -> Vector3: ...
    def __ne__(self, left: Vector3, right: Vector3) -> bool: ...
    def __lshift__(self, value: Vector3, shiftAmount: int) -> Vector3: ...
    @typing.overload
    ...
    def __invert__(self, value: Vector3) -> Vector3: ...
    def __rshift__(self, value: Vector3, shiftAmount: int) -> Vector3: ...
    def __sub__(self, left: Vector3, right: Vector3) -> Vector3: ...
    def __neg__(self, value: Vector3) -> Vector3: ...
    def __pos__(self, value: Vector3) -> Vector3: ...
    # Operator not supported op_UnsignedRightShift(value: Vector3, shiftAmount: Int32)
    @staticmethod
    def RadiansToDegrees(radians: Vector3) -> Vector3: ...
    @staticmethod
    def Reflect(vector: Vector3, normal: Vector3) -> Vector3: ...
    @staticmethod
    def Shuffle(vector: Vector3, xIndex: int, yIndex: int, zIndex: int) -> Vector3: ...
    @staticmethod
    def Sin(vector: Vector3) -> Vector3: ...
    @staticmethod
    def SinCos(vector: Vector3) -> ValueTuple_2[Vector3, Vector3]: ...
    @staticmethod
    def SquareRoot(value: Vector3) -> Vector3: ...
    @staticmethod
    def Subtract(left: Vector3, right: Vector3) -> Vector3: ...
    @staticmethod
    def Sum(value: Vector3) -> float: ...
    @staticmethod
    def TransformNormal(normal: Vector3, matrix: Matrix4x4) -> Vector3: ...
    @staticmethod
    def Truncate(vector: Vector3) -> Vector3: ...
    def TryCopyTo(self, destination: Span_1[float]) -> bool: ...
    @staticmethod
    def Xor(left: Vector3, right: Vector3) -> Vector3: ...
    # Skipped CopyTo due to it being static, abstract and generic.
    ...
    class Create_MethodGroup:
        @typing.overload
        def __call__(self, value: float) -> Vector3:...
        @typing.overload
        def __call__(self, values: ReadOnlySpan_1[float]) -> Vector3:...
        @typing.overload
        def __call__(self, vector: Vector2, z: float) -> Vector3:...
        @typing.overload
    ...
    class Lerp_MethodGroup:
        ...
        @typing.overload
        def __call__(self, value1: Vector3, value2: Vector3, amount: Vector3) -> Vector3:...
    ...
    class LoadUnsafe_MethodGroup:
        @typing.overload
        def __call__(self, source: clr.Reference[float]) -> Vector3:...
        @typing.overload
        def __call__(self, source: clr.Reference[float], elementOffset: UIntPtr) -> Vector3:...
    ...
    class Round_MethodGroup:
        ...
        @typing.overload
        def __call__(self, vector: Vector3, mode: MidpointRounding) -> Vector3:...
...
class Vector4(IFormattable, IEquatable_1[Vector4]):
    ...
    @classmethod
    @property
    def AllBitsSet(cls) -> Vector4: ...
    @classmethod
    @property
    def E(cls) -> Vector4: ...
    @classmethod
    @property
    def Epsilon(cls) -> Vector4: ...
    @classmethod
    @property
    def NaN(cls) -> Vector4: ...
    @classmethod
    ...
    @staticmethod
    def All(vector: Vector4, value: float) -> bool: ...
    @staticmethod
    def AllWhereAllBitsSet(vector: Vector4) -> bool: ...
    @staticmethod
    def AndNot(left: Vector4, right: Vector4) -> Vector4: ...
    @staticmethod
    def Any(vector: Vector4, value: float) -> bool: ...
    @staticmethod
    def AnyWhereAllBitsSet(vector: Vector4) -> bool: ...
    @staticmethod
    def BitwiseAnd(left: Vector4, right: Vector4) -> Vector4: ...
    @staticmethod
    def BitwiseOr(left: Vector4, right: Vector4) -> Vector4: ...
    @staticmethod
    def Clamp(value1: Vector4, min: Vector4, max: Vector4) -> Vector4: ...
    @staticmethod
    def ClampNative(value1: Vector4, min: Vector4, max: Vector4) -> Vector4: ...
    @staticmethod
    def ConditionalSelect(condition: Vector4, left: Vector4, right: Vector4) -> Vector4: ...
    @staticmethod
    def CopySign(value: Vector4, sign: Vector4) -> Vector4: ...
    @staticmethod
    def Cos(vector: Vector4) -> Vector4: ...
    @staticmethod
    def Count(vector: Vector4, value: float) -> int: ...
    @staticmethod
    def CountWhereAllBitsSet(vector: Vector4) -> int: ...
    @staticmethod
    def CreateScalar(x: float) -> Vector4: ...
    @staticmethod
    def CreateScalarUnsafe(x: float) -> Vector4: ...
    @staticmethod
    def Cross(vector1: Vector4, vector2: Vector4) -> Vector4: ...
    @staticmethod
    def DegreesToRadians(degrees: Vector4) -> Vector4: ...
    @staticmethod
    ...
    @staticmethod
    def EqualsAll(left: Vector4, right: Vector4) -> bool: ...
    @staticmethod
    def EqualsAny(left: Vector4, right: Vector4) -> bool: ...
    @staticmethod
    def Exp(vector: Vector4) -> Vector4: ...
    @staticmethod
    def FusedMultiplyAdd(left: Vector4, right: Vector4, addend: Vector4) -> Vector4: ...
    def GetHashCode(self) -> int: ...
    @staticmethod
    def GreaterThan(left: Vector4, right: Vector4) -> Vector4: ...
    @staticmethod
    def GreaterThanAll(left: Vector4, right: Vector4) -> bool: ...
    @staticmethod
    def GreaterThanAny(left: Vector4, right: Vector4) -> bool: ...
    @staticmethod
    def GreaterThanOrEqual(left: Vector4, right: Vector4) -> Vector4: ...
    @staticmethod
    def GreaterThanOrEqualAll(left: Vector4, right: Vector4) -> bool: ...
    @staticmethod
    def GreaterThanOrEqualAny(left: Vector4, right: Vector4) -> bool: ...
    @staticmethod
    def Hypot(x: Vector4, y: Vector4) -> Vector4: ...
    @staticmethod
    def IndexOf(vector: Vector4, value: float) -> int: ...
    @staticmethod
    def IndexOfWhereAllBitsSet(vector: Vector4) -> int: ...
    @staticmethod
    def IsEvenInteger(vector: Vector4) -> Vector4: ...
    @staticmethod
    def IsFinite(vector: Vector4) -> Vector4: ...
    @staticmethod
    def IsInfinity(vector: Vector4) -> Vector4: ...
    @staticmethod
    def IsInteger(vector: Vector4) -> Vector4: ...
    @staticmethod
    def IsNaN(vector: Vector4) -> Vector4: ...
    @staticmethod
    def IsNegative(vector: Vector4) -> Vector4: ...
    @staticmethod
    def IsNegativeInfinity(vector: Vector4) -> Vector4: ...
    @staticmethod
    def IsNormal(vector: Vector4) -> Vector4: ...
    @staticmethod
    def IsOddInteger(vector: Vector4) -> Vector4: ...
    @staticmethod
    def IsPositive(vector: Vector4) -> Vector4: ...
    @staticmethod
    def IsPositiveInfinity(vector: Vector4) -> Vector4: ...
    @staticmethod
    def IsSubnormal(vector: Vector4) -> Vector4: ...
    @staticmethod
    def IsZero(vector: Vector4) -> Vector4: ...
    @staticmethod
    def LastIndexOf(vector: Vector4, value: float) -> int: ...
    @staticmethod
    def LastIndexOfWhereAllBitsSet(vector: Vector4) -> int: ...
    def Length(self) -> float: ...
    def LengthSquared(self) -> float: ...
    @staticmethod
    def LessThan(left: Vector4, right: Vector4) -> Vector4: ...
    @staticmethod
    def LessThanAll(left: Vector4, right: Vector4) -> bool: ...
    @staticmethod
    def LessThanAny(left: Vector4, right: Vector4) -> bool: ...
    @staticmethod
    def LessThanOrEqual(left: Vector4, right: Vector4) -> Vector4: ...
    @staticmethod
    def LessThanOrEqualAll(left: Vector4, right: Vector4) -> bool: ...
    @staticmethod
    def LessThanOrEqualAny(left: Vector4, right: Vector4) -> bool: ...
    @staticmethod
    def Load(source: clr.Reference[float]) -> Vector4: ...
    @staticmethod
    def LoadAligned(source: clr.Reference[float]) -> Vector4: ...
    @staticmethod
    def LoadAlignedNonTemporal(source: clr.Reference[float]) -> Vector4: ...
    @staticmethod
    def Log(vector: Vector4) -> Vector4: ...
    @staticmethod
    def Log2(vector: Vector4) -> Vector4: ...
    @staticmethod
    def Max(value1: Vector4, value2: Vector4) -> Vector4: ...
    @staticmethod
    def MaxMagnitude(value1: Vector4, value2: Vector4) -> Vector4: ...
    @staticmethod
    def MaxMagnitudeNumber(value1: Vector4, value2: Vector4) -> Vector4: ...
    @staticmethod
    def MaxNative(value1: Vector4, value2: Vector4) -> Vector4: ...
    @staticmethod
    def MaxNumber(value1: Vector4, value2: Vector4) -> Vector4: ...
    @staticmethod
    def Min(value1: Vector4, value2: Vector4) -> Vector4: ...
    @staticmethod
    def MinMagnitude(value1: Vector4, value2: Vector4) -> Vector4: ...
    @staticmethod
    def MinMagnitudeNumber(value1: Vector4, value2: Vector4) -> Vector4: ...
    @staticmethod
    def MinNative(value1: Vector4, value2: Vector4) -> Vector4: ...
    @staticmethod
    def MinNumber(value1: Vector4, value2: Vector4) -> Vector4: ...
    @staticmethod
    def MultiplyAddEstimate(left: Vector4, right: Vector4, addend: Vector4) -> Vector4: ...
    @staticmethod
    def Negate(value: Vector4) -> Vector4: ...
    @staticmethod
    def None(vector: Vector4, value: float) -> bool: ...
    @staticmethod
    def NoneWhereAllBitsSet(vector: Vector4) -> bool: ...
    @staticmethod
    def Normalize(vector: Vector4) -> Vector4: ...
    @staticmethod
    def OnesComplement(value: Vector4) -> Vector4: ...
    def __add__(self, left: Vector4, right: Vector4) -> Vector4: ...
    def __and__(self, left: Vector4, right: Vector4) -> Vector4: ...
    def __or__(self, left: Vector4, right: Vector4) -> Vector4: ...
    @typing.overload
    ...
    def __xor__(self, left: Vector4, right: Vector4) -> Vector4: ...
    def __ne__(self, left: Vector4, right: Vector4) -> bool: ...
    def __lshift__(self, value: Vector4, shiftAmount: int) -> Vector4: ...
    @typing.overload
    ...
    def __invert__(self, value: Vector4) -> Vector4: ...
    def __rshift__(self, value: Vector4, shiftAmount: int) -> Vector4: ...
    def __sub__(self, left: Vector4, right: Vector4) -> Vector4: ...
    def __neg__(self, value: Vector4) -> Vector4: ...
    def __pos__(self, value: Vector4) -> Vector4: ...
    # Operator not supported op_UnsignedRightShift(value: Vector4, shiftAmount: Int32)
    @staticmethod
    def RadiansToDegrees(radians: Vector4) -> Vector4: ...
    @staticmethod
    def Shuffle(vector: Vector4, xIndex: int, yIndex: int, zIndex: int, wIndex: int) -> Vector4: ...
    @staticmethod
    def Sin(vector: Vector4) -> Vector4: ...
    @staticmethod
    def SinCos(vector: Vector4) -> ValueTuple_2[Vector4, Vector4]: ...
    @staticmethod
    def SquareRoot(value: Vector4) -> Vector4: ...
    @staticmethod
    def Subtract(left: Vector4, right: Vector4) -> Vector4: ...
    @staticmethod
    def Sum(value: Vector4) -> float: ...
    @staticmethod
    def Truncate(vector: Vector4) -> Vector4: ...
    def TryCopyTo(self, destination: Span_1[float]) -> bool: ...
    @staticmethod
    def Xor(left: Vector4, right: Vector4) -> Vector4: ...
    # Skipped CopyTo due to it being static, abstract and generic.
    ...
    class Create_MethodGroup:
        @typing.overload
        def __call__(self, value: float) -> Vector4:...
        @typing.overload
        def __call__(self, values: ReadOnlySpan_1[float]) -> Vector4:...
        @typing.overload
        def __call__(self, vector: Vector3, w: float) -> Vector4:...
        @typing.overload
        def __call__(self, vector: Vector2, z: float, w: float) -> Vector4:...
        @typing.overload
        def __call__(self, x: float, y: float, z: float, w: float) -> Vector4:...
    ...
    class Lerp_MethodGroup:
        ...
        @typing.overload
        def __call__(self, value1: Vector4, value2: Vector4, amount: Vector4) -> Vector4:...
    ...
    class LoadUnsafe_MethodGroup:
        @typing.overload
        def __call__(self, source: clr.Reference[float]) -> Vector4:...
        @typing.overload
        def __call__(self, source: clr.Reference[float], elementOffset: UIntPtr) -> Vector4:...
    ...
    class Round_MethodGroup:
        @typing.overload
        def __call__(self, vector: Vector4) -> Vector4:...
        @typing.overload
        def __call__(self, vector: Vector4, mode: MidpointRounding) -> Vector4:...
