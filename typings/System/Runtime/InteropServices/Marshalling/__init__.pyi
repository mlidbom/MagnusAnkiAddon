...
from System import Span_1, Array_1, ReadOnlySpan_1, IDisposable, Attribute
...
class ComVariant(IDisposable):
    @classmethod
    @property
    def Null(cls) -> ComVariant: ...
    @property
    def VarType(self) -> VarEnum: ...
    @VarType.setter
    def VarType(self, value: VarEnum) -> VarEnum: ...
    ...
    class As_MethodGroup:
        ...
        class As_1(typing.Generic[As_1_T1]):
            As_1_T = ComVariant.As_MethodGroup.As_1_T1
            def __call__(self) -> As_1_T:...
    ...
    class Create_MethodGroup:
        ...
        class Create_1(typing.Generic[Create_1_T1]):
            Create_1_T = ComVariant.Create_MethodGroup.Create_1_T1
            def __call__(self, value: Create_1_T) -> ComVariant:...


    # Skipped CreateRaw due to it being static, abstract and generic.

    CreateRaw : CreateRaw_MethodGroup
    class CreateRaw_MethodGroup:
        def __getitem__(self, t:typing.Type[CreateRaw_1_T1]) -> CreateRaw_1[CreateRaw_1_T1]: ...

        CreateRaw_1_T1 = typing.TypeVar('CreateRaw_1_T1')
        class CreateRaw_1(typing.Generic[CreateRaw_1_T1]):
            CreateRaw_1_T = ComVariant.CreateRaw_MethodGroup.CreateRaw_1_T1
            def __call__(self, vt: VarEnum, rawValue: CreateRaw_1_T) -> ComVariant:...


    # Skipped GetRawDataRef due to it being static, abstract and generic.

    GetRawDataRef : GetRawDataRef_MethodGroup
    class GetRawDataRef_MethodGroup:
        def __getitem__(self, t:typing.Type[GetRawDataRef_1_T1]) -> GetRawDataRef_1[GetRawDataRef_1_T1]: ...

        GetRawDataRef_1_T1 = typing.TypeVar('GetRawDataRef_1_T1')
        class GetRawDataRef_1(typing.Generic[GetRawDataRef_1_T1]):
            GetRawDataRef_1_T = ComVariant.GetRawDataRef_MethodGroup.GetRawDataRef_1_T1
            def __call__(self) -> clr.Reference[GetRawDataRef_1_T]:...
...
class ReadOnlySpanMarshaller_2(typing.Generic[ReadOnlySpanMarshaller_2_T, ReadOnlySpanMarshaller_2_TUnmanagedElement], abc.ABC):
    ...
    ManagedToUnmanagedOut_GenericClasses_ReadOnlySpanMarshaller_2_T = typing.TypeVar('ManagedToUnmanagedOut_GenericClasses_ReadOnlySpanMarshaller_2_T')
    ManagedToUnmanagedOut_GenericClasses_ReadOnlySpanMarshaller_2_TUnmanagedElement = typing.TypeVar('ManagedToUnmanagedOut_GenericClasses_ReadOnlySpanMarshaller_2_TUnmanagedElement')
    class ManagedToUnmanagedOut_GenericClasses(typing.Generic[ManagedToUnmanagedOut_GenericClasses_ReadOnlySpanMarshaller_2_T, ManagedToUnmanagedOut_GenericClasses_ReadOnlySpanMarshaller_2_TUnmanagedElement], abc.ABCMeta):
        ManagedToUnmanagedOut_GenericClasses_ReadOnlySpanMarshaller_2_T = ReadOnlySpanMarshaller_2.ManagedToUnmanagedOut_GenericClasses_ReadOnlySpanMarshaller_2_T
        ManagedToUnmanagedOut_GenericClasses_ReadOnlySpanMarshaller_2_TUnmanagedElement = ReadOnlySpanMarshaller_2.ManagedToUnmanagedOut_GenericClasses_ReadOnlySpanMarshaller_2_TUnmanagedElement
        def __call__(self) -> ReadOnlySpanMarshaller_2.ManagedToUnmanagedOut_2[ManagedToUnmanagedOut_GenericClasses_ReadOnlySpanMarshaller_2_T, ManagedToUnmanagedOut_GenericClasses_ReadOnlySpanMarshaller_2_TUnmanagedElement]: ...

    ManagedToUnmanagedOut : ManagedToUnmanagedOut_GenericClasses[ReadOnlySpanMarshaller_2_T, ReadOnlySpanMarshaller_2_TUnmanagedElement]

    ManagedToUnmanagedOut_2_T = typing.TypeVar('ManagedToUnmanagedOut_2_T')
    ManagedToUnmanagedOut_2_TUnmanagedElement = typing.TypeVar('ManagedToUnmanagedOut_2_TUnmanagedElement')
    class ManagedToUnmanagedOut_2(typing.Generic[ManagedToUnmanagedOut_2_T, ManagedToUnmanagedOut_2_TUnmanagedElement]):
        ManagedToUnmanagedOut_2_T = ReadOnlySpanMarshaller_2.ManagedToUnmanagedOut_2_T
        ManagedToUnmanagedOut_2_TUnmanagedElement = ReadOnlySpanMarshaller_2.ManagedToUnmanagedOut_2_TUnmanagedElement
        def Free(self) -> None: ...
        def FromUnmanaged(self, unmanaged: clr.Reference[ManagedToUnmanagedOut_2_TUnmanagedElement]) -> None: ...
        def GetManagedValuesDestination(self, numElements: int) -> Span_1[ManagedToUnmanagedOut_2_T]: ...
        def GetUnmanagedValuesSource(self, numElements: int) -> ReadOnlySpan_1[ManagedToUnmanagedOut_2_TUnmanagedElement]: ...
        def ToManaged(self) -> ReadOnlySpan_1[ManagedToUnmanagedOut_2_T]: ...
