...
from System import Attribute, IEquatable_1, Span_1, Guid, Delegate, Exception, IDisposable, UIntPtr, Decimal, MulticastDelegate, IAsyncResult, AsyncCallback, SystemException, Array, Array_1, MarshalByRefObject, RuntimeTypeHandle, ReadOnlyMemory_1, ReadOnlySpan_1, Memory_1, ArraySegment_1, ValueTuple_2, IFormatProvider, MidpointRounding, Action_1
from System.Collections import BitArray, IDictionary
from System.Collections.Generic import List_1, Dictionary_2, IEnumerable_1, IReadOnlyDictionary_2
...
class CollectionsMarshal(abc.ABC):
    @staticmethod
    def AsBytes(array: BitArray) -> Span_1[int]: ...
    ...
    class GetValueRefOrAddDefault_MethodGroup:
        ...
        @typing.overload
        def __getitem__(self, t:typing.Tuple[typing.Type[GetValueRefOrAddDefault_3_T1], typing.Type[GetValueRefOrAddDefault_3_T2], typing.Type[GetValueRefOrAddDefault_3_T3]]) -> GetValueRefOrAddDefault_3[GetValueRefOrAddDefault_3_T1, GetValueRefOrAddDefault_3_T2, GetValueRefOrAddDefault_3_T3]: ...

        GetValueRefOrAddDefault_3_T1 = typing.TypeVar('GetValueRefOrAddDefault_3_T1')
        GetValueRefOrAddDefault_3_T2 = typing.TypeVar('GetValueRefOrAddDefault_3_T2')
        GetValueRefOrAddDefault_3_T3 = typing.TypeVar('GetValueRefOrAddDefault_3_T3')
        class GetValueRefOrAddDefault_3(typing.Generic[GetValueRefOrAddDefault_3_T1, GetValueRefOrAddDefault_3_T2, GetValueRefOrAddDefault_3_T3]):
            GetValueRefOrAddDefault_3_TKey = CollectionsMarshal.GetValueRefOrAddDefault_MethodGroup.GetValueRefOrAddDefault_3_T1
            GetValueRefOrAddDefault_3_TValue = CollectionsMarshal.GetValueRefOrAddDefault_MethodGroup.GetValueRefOrAddDefault_3_T2
            GetValueRefOrAddDefault_3_TAlternateKey = CollectionsMarshal.GetValueRefOrAddDefault_MethodGroup.GetValueRefOrAddDefault_3_T3
            def __call__(self, dictionary: Dictionary_2.AlternateLookup_3[GetValueRefOrAddDefault_3_TKey, GetValueRefOrAddDefault_3_TValue, GetValueRefOrAddDefault_3_TAlternateKey], key: GetValueRefOrAddDefault_3_TAlternateKey, exists: clr.Reference[bool]) -> clr.Reference[GetValueRefOrAddDefault_3_TValue]:...
    ...
    class GetValueRefOrNullRef_MethodGroup:
        ...
        @typing.overload
        def __getitem__(self, t:typing.Tuple[typing.Type[GetValueRefOrNullRef_3_T1], typing.Type[GetValueRefOrNullRef_3_T2], typing.Type[GetValueRefOrNullRef_3_T3]]) -> GetValueRefOrNullRef_3[GetValueRefOrNullRef_3_T1, GetValueRefOrNullRef_3_T2, GetValueRefOrNullRef_3_T3]: ...

        GetValueRefOrNullRef_3_T1 = typing.TypeVar('GetValueRefOrNullRef_3_T1')
        GetValueRefOrNullRef_3_T2 = typing.TypeVar('GetValueRefOrNullRef_3_T2')
        GetValueRefOrNullRef_3_T3 = typing.TypeVar('GetValueRefOrNullRef_3_T3')
        class GetValueRefOrNullRef_3(typing.Generic[GetValueRefOrNullRef_3_T1, GetValueRefOrNullRef_3_T2, GetValueRefOrNullRef_3_T3]):
            GetValueRefOrNullRef_3_TKey = CollectionsMarshal.GetValueRefOrNullRef_MethodGroup.GetValueRefOrNullRef_3_T1
            GetValueRefOrNullRef_3_TValue = CollectionsMarshal.GetValueRefOrNullRef_MethodGroup.GetValueRefOrNullRef_3_T2
            GetValueRefOrNullRef_3_TAlternateKey = CollectionsMarshal.GetValueRefOrNullRef_MethodGroup.GetValueRefOrNullRef_3_T3
            def __call__(self, dictionary: Dictionary_2.AlternateLookup_3[GetValueRefOrNullRef_3_TKey, GetValueRefOrNullRef_3_TValue, GetValueRefOrNullRef_3_TAlternateKey], key: GetValueRefOrNullRef_3_TAlternateKey) -> clr.Reference[GetValueRefOrNullRef_3_TValue]:...
...
class ComWrappers(abc.ABC):
    ...
    # Skipped GetOrCreateObjectForComInstance due to it being static, abstract and generic.

    GetOrCreateObjectForComInstance : GetOrCreateObjectForComInstance_MethodGroup
    class GetOrCreateObjectForComInstance_MethodGroup:
        @typing.overload
        def __call__(self, externalComObject: int, flags: CreateObjectFlags) -> typing.Any:...
        @typing.overload
        def __call__(self, externalComObject: int, flags: CreateObjectFlags, userState: typing.Any) -> typing.Any:...
...
class CreatedWrapperFlags(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    None_ : CreatedWrapperFlags # 0
    TrackerObject : CreatedWrapperFlags # 1
    NonWrapping : CreatedWrapperFlags # 2
...
class GCHandle_GenericClasses(abc.ABCMeta):
    Generic_GCHandle_GenericClasses_GCHandle_1_T = typing.TypeVar('Generic_GCHandle_GenericClasses_GCHandle_1_T')
    def __getitem__(self, types : typing.Type[Generic_GCHandle_GenericClasses_GCHandle_1_T]) -> typing.Type[GCHandle_1[Generic_GCHandle_GenericClasses_GCHandle_1_T]]: ...

class GCHandle(GCHandle_0, metaclass =GCHandle_GenericClasses): ...

class GCHandle_0(IEquatable_1[GCHandle]):
    @property
...
GCHandle_1_T = typing.TypeVar('GCHandle_1_T')
class GCHandle_1(typing.Generic[GCHandle_1_T], IDisposable, IEquatable_1[GCHandle_1[GCHandle_1_T]]):
    def __init__(self, target: GCHandle_1_T) -> None: ...
    @property
    def IsAllocated(self) -> bool: ...
    @property
    def Target(self) -> GCHandle_1_T: ...
    @Target.setter
    def Target(self, value: GCHandle_1_T) -> GCHandle_1_T: ...
    def Dispose(self) -> None: ...
    @staticmethod
    def FromIntPtr(value: int) -> GCHandle_1[GCHandle_1_T]: ...
    def GetHashCode(self) -> int: ...
    @staticmethod
    def ToIntPtr(value: GCHandle_1[GCHandle_1_T]) -> int: ...
    # Skipped Equals due to it being static, abstract and generic.

    Equals : Equals_MethodGroup[GCHandle_1_T]
    Equals_MethodGroup_GCHandle_1_T = typing.TypeVar('Equals_MethodGroup_GCHandle_1_T')
    class Equals_MethodGroup(typing.Generic[Equals_MethodGroup_GCHandle_1_T]):
        Equals_MethodGroup_GCHandle_1_T = GCHandle_1.Equals_MethodGroup_GCHandle_1_T
        @typing.overload
        def __call__(self, other: GCHandle_1[Equals_MethodGroup_GCHandle_1_T]) -> bool:...
        @typing.overload
        def __call__(self, obj: typing.Any) -> bool:...



class GCHandleExtensions(abc.ABC):
    @staticmethod
    def GetAddressOfStringData(handle: PinnedGCHandle_1[str]) -> clr.Reference[str]: ...
    # Skipped GetAddressOfArrayData due to it being static, abstract and generic.

    GetAddressOfArrayData : GetAddressOfArrayData_MethodGroup
    class GetAddressOfArrayData_MethodGroup:
        def __getitem__(self, t:typing.Type[GetAddressOfArrayData_1_T1]) -> GetAddressOfArrayData_1[GetAddressOfArrayData_1_T1]: ...

        GetAddressOfArrayData_1_T1 = typing.TypeVar('GetAddressOfArrayData_1_T1')
        class GetAddressOfArrayData_1(typing.Generic[GetAddressOfArrayData_1_T1]):
            GetAddressOfArrayData_1_T = GCHandleExtensions.GetAddressOfArrayData_MethodGroup.GetAddressOfArrayData_1_T1
            def __call__(self, handle: PinnedGCHandle_1[Array_1[GetAddressOfArrayData_1_T]]) -> clr.Reference[GetAddressOfArrayData_1_T]:...
...
class Marshal(abc.ABC):
    ...
    class GetExceptionForHR_MethodGroup:
        ...
        @typing.overload
        def __call__(self, errorCode: int, iid: clr.Reference[Guid], pUnk: int) -> Exception:...
    ...
    class ThrowExceptionForHR_MethodGroup:
        ...
        @typing.overload
        def __call__(self, errorCode: int, iid: clr.Reference[Guid], pUnk: int) -> None:...
...
class NFloat(IBinaryFloatingPointIeee754_1[NFloat], IMinMaxValue_1[NFloat]):
    ...
    @staticmethod
    def ClampNative(value: NFloat, min: NFloat, max: NFloat) -> NFloat: ...
    @staticmethod
    ...
    @staticmethod
    def MaxNative(x: NFloat, y: NFloat) -> NFloat: ...
    @staticmethod
    ...
    @staticmethod
    def MinNative(x: NFloat, y: NFloat) -> NFloat: ...
    @staticmethod
    def MinNumber(x: NFloat, y: NFloat) -> NFloat: ...
    @staticmethod
    def MultiplyAddEstimate(left: NFloat, right: NFloat, addend: NFloat) -> NFloat: ...
    ...
    ConvertToInteger : ConvertToInteger_MethodGroup
    class ConvertToInteger_MethodGroup:
        def __getitem__(self, t:typing.Type[ConvertToInteger_1_T1]) -> ConvertToInteger_1[ConvertToInteger_1_T1]: ...

        ConvertToInteger_1_T1 = typing.TypeVar('ConvertToInteger_1_T1')
        class ConvertToInteger_1(typing.Generic[ConvertToInteger_1_T1]):
            ConvertToInteger_1_TInteger = NFloat.ConvertToInteger_MethodGroup.ConvertToInteger_1_T1
            def __call__(self, value: NFloat) -> ConvertToInteger_1_TInteger:...


    # Skipped ConvertToIntegerNative due to it being static, abstract and generic.

    ConvertToIntegerNative : ConvertToIntegerNative_MethodGroup
    class ConvertToIntegerNative_MethodGroup:
        def __getitem__(self, t:typing.Type[ConvertToIntegerNative_1_T1]) -> ConvertToIntegerNative_1[ConvertToIntegerNative_1_T1]: ...

        ConvertToIntegerNative_1_T1 = typing.TypeVar('ConvertToIntegerNative_1_T1')
        class ConvertToIntegerNative_1(typing.Generic[ConvertToIntegerNative_1_T1]):
            ConvertToIntegerNative_1_TInteger = NFloat.ConvertToIntegerNative_MethodGroup.ConvertToIntegerNative_1_T1
            def __call__(self, value: NFloat) -> ConvertToIntegerNative_1_TInteger:...
...
class PinnedGCHandle_GenericClasses(abc.ABCMeta):
    Generic_PinnedGCHandle_GenericClasses_PinnedGCHandle_1_T = typing.TypeVar('Generic_PinnedGCHandle_GenericClasses_PinnedGCHandle_1_T')
    def __getitem__(self, types : typing.Type[Generic_PinnedGCHandle_GenericClasses_PinnedGCHandle_1_T]) -> typing.Type[PinnedGCHandle_1[Generic_PinnedGCHandle_GenericClasses_PinnedGCHandle_1_T]]: ...

PinnedGCHandle : PinnedGCHandle_GenericClasses

PinnedGCHandle_1_T = typing.TypeVar('PinnedGCHandle_1_T')
class PinnedGCHandle_1(typing.Generic[PinnedGCHandle_1_T], IDisposable, IEquatable_1[PinnedGCHandle_1[PinnedGCHandle_1_T]]):
    def __init__(self, target: PinnedGCHandle_1_T) -> None: ...
    @property
    def IsAllocated(self) -> bool: ...
    @property
    def Target(self) -> PinnedGCHandle_1_T: ...
    @Target.setter
    def Target(self, value: PinnedGCHandle_1_T) -> PinnedGCHandle_1_T: ...
    def Dispose(self) -> None: ...
    @staticmethod
    def FromIntPtr(value: int) -> PinnedGCHandle_1[PinnedGCHandle_1_T]: ...
    def GetAddressOfObjectData(self) -> clr.Reference[None]: ...
    def GetHashCode(self) -> int: ...
    @staticmethod
    def ToIntPtr(value: PinnedGCHandle_1[PinnedGCHandle_1_T]) -> int: ...
    # Skipped Equals due to it being static, abstract and generic.

    Equals : Equals_MethodGroup[PinnedGCHandle_1_T]
    Equals_MethodGroup_PinnedGCHandle_1_T = typing.TypeVar('Equals_MethodGroup_PinnedGCHandle_1_T')
    class Equals_MethodGroup(typing.Generic[Equals_MethodGroup_PinnedGCHandle_1_T]):
        Equals_MethodGroup_PinnedGCHandle_1_T = PinnedGCHandle_1.Equals_MethodGroup_PinnedGCHandle_1_T
        @typing.overload
        def __call__(self, other: PinnedGCHandle_1[Equals_MethodGroup_PinnedGCHandle_1_T]) -> bool:...
        @typing.overload
        def __call__(self, obj: typing.Any) -> bool:...
...
class TypeMapAssemblyTargetAttribute_GenericClasses(abc.ABCMeta):
    Generic_TypeMapAssemblyTargetAttribute_GenericClasses_TypeMapAssemblyTargetAttribute_1_TTypeMapGroup = typing.TypeVar('Generic_TypeMapAssemblyTargetAttribute_GenericClasses_TypeMapAssemblyTargetAttribute_1_TTypeMapGroup')
    def __getitem__(self, types : typing.Type[Generic_TypeMapAssemblyTargetAttribute_GenericClasses_TypeMapAssemblyTargetAttribute_1_TTypeMapGroup]) -> typing.Type[TypeMapAssemblyTargetAttribute_1[Generic_TypeMapAssemblyTargetAttribute_GenericClasses_TypeMapAssemblyTargetAttribute_1_TTypeMapGroup]]: ...

TypeMapAssemblyTargetAttribute : TypeMapAssemblyTargetAttribute_GenericClasses

TypeMapAssemblyTargetAttribute_1_TTypeMapGroup = typing.TypeVar('TypeMapAssemblyTargetAttribute_1_TTypeMapGroup')
class TypeMapAssemblyTargetAttribute_1(typing.Generic[TypeMapAssemblyTargetAttribute_1_TTypeMapGroup], Attribute):
    def __init__(self, assemblyName: str) -> None: ...
    @property
    def TypeId(self) -> typing.Any: ...


class TypeMapAssociationAttribute_GenericClasses(abc.ABCMeta):
    Generic_TypeMapAssociationAttribute_GenericClasses_TypeMapAssociationAttribute_1_TTypeMapGroup = typing.TypeVar('Generic_TypeMapAssociationAttribute_GenericClasses_TypeMapAssociationAttribute_1_TTypeMapGroup')
    def __getitem__(self, types : typing.Type[Generic_TypeMapAssociationAttribute_GenericClasses_TypeMapAssociationAttribute_1_TTypeMapGroup]) -> typing.Type[TypeMapAssociationAttribute_1[Generic_TypeMapAssociationAttribute_GenericClasses_TypeMapAssociationAttribute_1_TTypeMapGroup]]: ...

TypeMapAssociationAttribute : TypeMapAssociationAttribute_GenericClasses

TypeMapAssociationAttribute_1_TTypeMapGroup = typing.TypeVar('TypeMapAssociationAttribute_1_TTypeMapGroup')
class TypeMapAssociationAttribute_1(typing.Generic[TypeMapAssociationAttribute_1_TTypeMapGroup], Attribute):
    def __init__(self, source: typing.Type[typing.Any], proxy: typing.Type[typing.Any]) -> None: ...
    @property
    def TypeId(self) -> typing.Any: ...


class TypeMapAttribute_GenericClasses(abc.ABCMeta):
    Generic_TypeMapAttribute_GenericClasses_TypeMapAttribute_1_TTypeMapGroup = typing.TypeVar('Generic_TypeMapAttribute_GenericClasses_TypeMapAttribute_1_TTypeMapGroup')
    def __getitem__(self, types : typing.Type[Generic_TypeMapAttribute_GenericClasses_TypeMapAttribute_1_TTypeMapGroup]) -> typing.Type[TypeMapAttribute_1[Generic_TypeMapAttribute_GenericClasses_TypeMapAttribute_1_TTypeMapGroup]]: ...

TypeMapAttribute : TypeMapAttribute_GenericClasses

TypeMapAttribute_1_TTypeMapGroup = typing.TypeVar('TypeMapAttribute_1_TTypeMapGroup')
class TypeMapAttribute_1(typing.Generic[TypeMapAttribute_1_TTypeMapGroup], Attribute):
    @typing.overload
    def __init__(self, value: str, target: typing.Type[typing.Any]) -> None: ...
    @typing.overload
    def __init__(self, value: str, target: typing.Type[typing.Any], trimTarget: typing.Type[typing.Any]) -> None: ...
    @property
    def TypeId(self) -> typing.Any: ...


class TypeMapping(abc.ABC):
    # Skipped GetOrCreateExternalTypeMapping due to it being static, abstract and generic.

    GetOrCreateExternalTypeMapping : GetOrCreateExternalTypeMapping_MethodGroup
    class GetOrCreateExternalTypeMapping_MethodGroup:
        def __getitem__(self, t:typing.Type[GetOrCreateExternalTypeMapping_1_T1]) -> GetOrCreateExternalTypeMapping_1[GetOrCreateExternalTypeMapping_1_T1]: ...

        GetOrCreateExternalTypeMapping_1_T1 = typing.TypeVar('GetOrCreateExternalTypeMapping_1_T1')
        class GetOrCreateExternalTypeMapping_1(typing.Generic[GetOrCreateExternalTypeMapping_1_T1]):
            GetOrCreateExternalTypeMapping_1_TTypeMapGroup = TypeMapping.GetOrCreateExternalTypeMapping_MethodGroup.GetOrCreateExternalTypeMapping_1_T1
            def __call__(self) -> IReadOnlyDictionary_2[str, typing.Type[typing.Any]]:...


    # Skipped GetOrCreateProxyTypeMapping due to it being static, abstract and generic.

    GetOrCreateProxyTypeMapping : GetOrCreateProxyTypeMapping_MethodGroup
    class GetOrCreateProxyTypeMapping_MethodGroup:
        def __getitem__(self, t:typing.Type[GetOrCreateProxyTypeMapping_1_T1]) -> GetOrCreateProxyTypeMapping_1[GetOrCreateProxyTypeMapping_1_T1]: ...

        GetOrCreateProxyTypeMapping_1_T1 = typing.TypeVar('GetOrCreateProxyTypeMapping_1_T1')
        class GetOrCreateProxyTypeMapping_1(typing.Generic[GetOrCreateProxyTypeMapping_1_T1]):
            GetOrCreateProxyTypeMapping_1_TTypeMapGroup = TypeMapping.GetOrCreateProxyTypeMapping_MethodGroup.GetOrCreateProxyTypeMapping_1_T1
            def __call__(self) -> IReadOnlyDictionary_2[typing.Type[typing.Any], typing.Type[typing.Any]]:...
...
class WasmImportLinkageAttribute(Attribute):
    def __init__(self) -> None: ...
    @property
    def TypeId(self) -> typing.Any: ...


class WeakGCHandle_GenericClasses(abc.ABCMeta):
    Generic_WeakGCHandle_GenericClasses_WeakGCHandle_1_T = typing.TypeVar('Generic_WeakGCHandle_GenericClasses_WeakGCHandle_1_T')
    def __getitem__(self, types : typing.Type[Generic_WeakGCHandle_GenericClasses_WeakGCHandle_1_T]) -> typing.Type[WeakGCHandle_1[Generic_WeakGCHandle_GenericClasses_WeakGCHandle_1_T]]: ...

WeakGCHandle : WeakGCHandle_GenericClasses

WeakGCHandle_1_T = typing.TypeVar('WeakGCHandle_1_T')
class WeakGCHandle_1(typing.Generic[WeakGCHandle_1_T], IDisposable, IEquatable_1[WeakGCHandle_1[WeakGCHandle_1_T]]):
    def __init__(self, target: WeakGCHandle_1_T, trackResurrection: bool = ...) -> None: ...
    @property
    def IsAllocated(self) -> bool: ...
    def Dispose(self) -> None: ...
    @staticmethod
    def FromIntPtr(value: int) -> WeakGCHandle_1[WeakGCHandle_1_T]: ...
    def GetHashCode(self) -> int: ...
    def SetTarget(self, target: WeakGCHandle_1_T) -> None: ...
    @staticmethod
    def ToIntPtr(value: WeakGCHandle_1[WeakGCHandle_1_T]) -> int: ...
    def TryGetTarget(self, target: clr.Reference[WeakGCHandle_1_T]) -> bool: ...
    # Skipped Equals due to it being static, abstract and generic.

    Equals : Equals_MethodGroup[WeakGCHandle_1_T]
    Equals_MethodGroup_WeakGCHandle_1_T = typing.TypeVar('Equals_MethodGroup_WeakGCHandle_1_T')
    class Equals_MethodGroup(typing.Generic[Equals_MethodGroup_WeakGCHandle_1_T]):
        Equals_MethodGroup_WeakGCHandle_1_T = WeakGCHandle_1.Equals_MethodGroup_WeakGCHandle_1_T
        @typing.overload
        def __call__(self, other: WeakGCHandle_1[Equals_MethodGroup_WeakGCHandle_1_T]) -> bool:...
        @typing.overload
        def __call__(self, obj: typing.Any) -> bool:...
