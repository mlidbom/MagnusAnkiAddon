...
from System import Attribute, Exception, Func_3, Func_2, MulticastDelegate, IAsyncResult, AsyncCallback, Action, Decimal, IFormatProvider, Span_1, ReadOnlySpan_1, FormattableString, Array, Array_1, RuntimeTypeHandle, RuntimeFieldHandle, Delegate, ModuleHandle, Range, RuntimeMethodHandle, InvalidOperationException, UIntPtr
from System.Threading.Tasks import Task_1, ValueTask_1, ValueTask, Task
...
class AsyncHelpers(abc.ABC):
    # Skipped Await due to it being static, abstract and generic.

    Await : Await_MethodGroup
    class Await_MethodGroup:
        def __getitem__(self, t:typing.Type[Await_1_T1]) -> Await_1[Await_1_T1]: ...

        Await_1_T1 = typing.TypeVar('Await_1_T1')
        class Await_1(typing.Generic[Await_1_T1]):
            Await_1_T = AsyncHelpers.Await_MethodGroup.Await_1_T1
            @typing.overload
            def __call__(self, configuredAwaitable: ConfiguredTaskAwaitable_1[Await_1_T]) -> Await_1_T:...
            @typing.overload
            def __call__(self, configuredAwaitable: ConfiguredValueTaskAwaitable_1[Await_1_T]) -> Await_1_T:...
            @typing.overload
            def __call__(self, task: Task_1[Await_1_T]) -> Await_1_T:...
            @typing.overload
            def __call__(self, task: ValueTask_1[Await_1_T]) -> Await_1_T:...

        @typing.overload
        def __call__(self, configuredAwaitable: ConfiguredTaskAwaitable) -> None:...
        @typing.overload
        def __call__(self, configuredAwaitable: ConfiguredValueTaskAwaitable) -> None:...
        @typing.overload
        def __call__(self, task: ValueTask) -> None:...
        @typing.overload
        def __call__(self, task: Task) -> None:...

    # Skipped AwaitAwaiter due to it being static, abstract and generic.

    AwaitAwaiter : AwaitAwaiter_MethodGroup
    class AwaitAwaiter_MethodGroup:
        def __getitem__(self, t:typing.Type[AwaitAwaiter_1_T1]) -> AwaitAwaiter_1[AwaitAwaiter_1_T1]: ...

        AwaitAwaiter_1_T1 = typing.TypeVar('AwaitAwaiter_1_T1')
        class AwaitAwaiter_1(typing.Generic[AwaitAwaiter_1_T1]):
            AwaitAwaiter_1_TAwaiter = AsyncHelpers.AwaitAwaiter_MethodGroup.AwaitAwaiter_1_T1
            def __call__(self, awaiter: AwaitAwaiter_1_TAwaiter) -> None:...


    # Skipped UnsafeAwaitAwaiter due to it being static, abstract and generic.

    UnsafeAwaitAwaiter : UnsafeAwaitAwaiter_MethodGroup
    class UnsafeAwaitAwaiter_MethodGroup:
        def __getitem__(self, t:typing.Type[UnsafeAwaitAwaiter_1_T1]) -> UnsafeAwaitAwaiter_1[UnsafeAwaitAwaiter_1_T1]: ...

        UnsafeAwaitAwaiter_1_T1 = typing.TypeVar('UnsafeAwaitAwaiter_1_T1')
        class UnsafeAwaitAwaiter_1(typing.Generic[UnsafeAwaitAwaiter_1_T1]):
            UnsafeAwaitAwaiter_1_TAwaiter = AsyncHelpers.UnsafeAwaitAwaiter_MethodGroup.UnsafeAwaitAwaiter_1_T1
            def __call__(self, awaiter: UnsafeAwaitAwaiter_1_TAwaiter) -> None:...
...
class CompilerLoweringPreserveAttribute(Attribute):
    def __init__(self) -> None: ...
    @property
    def TypeId(self) -> typing.Any: ...
...
class ConditionalWeakTable_2(typing.Generic[ConditionalWeakTable_2_TKey, ConditionalWeakTable_2_TValue], IEnumerable_1[KeyValuePair_2[ConditionalWeakTable_2_TKey, ConditionalWeakTable_2_TValue]]):
    ...
    GetOrAdd : GetOrAdd_MethodGroup[ConditionalWeakTable_2_TKey, ConditionalWeakTable_2_TValue]
    GetOrAdd_MethodGroup_ConditionalWeakTable_2_TKey = typing.TypeVar('GetOrAdd_MethodGroup_ConditionalWeakTable_2_TKey')
    GetOrAdd_MethodGroup_ConditionalWeakTable_2_TValue = typing.TypeVar('GetOrAdd_MethodGroup_ConditionalWeakTable_2_TValue')
    class GetOrAdd_MethodGroup(typing.Generic[GetOrAdd_MethodGroup_ConditionalWeakTable_2_TKey, GetOrAdd_MethodGroup_ConditionalWeakTable_2_TValue]):
        GetOrAdd_MethodGroup_ConditionalWeakTable_2_TKey = ConditionalWeakTable_2.GetOrAdd_MethodGroup_ConditionalWeakTable_2_TKey
        GetOrAdd_MethodGroup_ConditionalWeakTable_2_TValue = ConditionalWeakTable_2.GetOrAdd_MethodGroup_ConditionalWeakTable_2_TValue
        def __getitem__(self, t:typing.Type[GetOrAdd_1_T1]) -> GetOrAdd_1[GetOrAdd_MethodGroup_ConditionalWeakTable_2_TKey, GetOrAdd_MethodGroup_ConditionalWeakTable_2_TValue, GetOrAdd_1_T1]: ...

        GetOrAdd_1_ConditionalWeakTable_2_TKey = typing.TypeVar('GetOrAdd_1_ConditionalWeakTable_2_TKey')
        GetOrAdd_1_ConditionalWeakTable_2_TValue = typing.TypeVar('GetOrAdd_1_ConditionalWeakTable_2_TValue')
        GetOrAdd_1_T1 = typing.TypeVar('GetOrAdd_1_T1')
        class GetOrAdd_1(typing.Generic[GetOrAdd_1_ConditionalWeakTable_2_TKey, GetOrAdd_1_ConditionalWeakTable_2_TValue, GetOrAdd_1_T1]):
            GetOrAdd_1_ConditionalWeakTable_2_TKey = ConditionalWeakTable_2.GetOrAdd_MethodGroup.GetOrAdd_1_ConditionalWeakTable_2_TKey
            GetOrAdd_1_ConditionalWeakTable_2_TValue = ConditionalWeakTable_2.GetOrAdd_MethodGroup.GetOrAdd_1_ConditionalWeakTable_2_TValue
            GetOrAdd_1_TArg = ConditionalWeakTable_2.GetOrAdd_MethodGroup.GetOrAdd_1_T1
            def __call__(self, key: GetOrAdd_1_ConditionalWeakTable_2_TKey, valueFactory: Func_3[GetOrAdd_1_ConditionalWeakTable_2_TKey, GetOrAdd_1_TArg, GetOrAdd_1_ConditionalWeakTable_2_TValue], factoryArgument: GetOrAdd_1_TArg) -> GetOrAdd_1_ConditionalWeakTable_2_TValue:...

        @typing.overload
        def __call__(self, key: GetOrAdd_MethodGroup_ConditionalWeakTable_2_TKey, valueFactory: Func_2[GetOrAdd_MethodGroup_ConditionalWeakTable_2_TKey, GetOrAdd_MethodGroup_ConditionalWeakTable_2_TValue]) -> GetOrAdd_MethodGroup_ConditionalWeakTable_2_TValue:...
        @typing.overload
        def __call__(self, key: GetOrAdd_MethodGroup_ConditionalWeakTable_2_TKey, value: GetOrAdd_MethodGroup_ConditionalWeakTable_2_TValue) -> GetOrAdd_MethodGroup_ConditionalWeakTable_2_TValue:...

    # Skipped Remove due to it being static, abstract and generic.

    Remove : Remove_MethodGroup[ConditionalWeakTable_2_TKey, ConditionalWeakTable_2_TValue]
    Remove_MethodGroup_ConditionalWeakTable_2_TKey = typing.TypeVar('Remove_MethodGroup_ConditionalWeakTable_2_TKey')
    Remove_MethodGroup_ConditionalWeakTable_2_TValue = typing.TypeVar('Remove_MethodGroup_ConditionalWeakTable_2_TValue')
    class Remove_MethodGroup(typing.Generic[Remove_MethodGroup_ConditionalWeakTable_2_TKey, Remove_MethodGroup_ConditionalWeakTable_2_TValue]):
        Remove_MethodGroup_ConditionalWeakTable_2_TKey = ConditionalWeakTable_2.Remove_MethodGroup_ConditionalWeakTable_2_TKey
        Remove_MethodGroup_ConditionalWeakTable_2_TValue = ConditionalWeakTable_2.Remove_MethodGroup_ConditionalWeakTable_2_TValue
        @typing.overload
        def __call__(self, key: Remove_MethodGroup_ConditionalWeakTable_2_TKey) -> bool:...
        @typing.overload
        def __call__(self, key: Remove_MethodGroup_ConditionalWeakTable_2_TKey, value: clr.Reference[Remove_MethodGroup_ConditionalWeakTable_2_TValue]) -> bool:...
...
class DefaultInterpolatedStringHandler:
    ...
    @property
    def Text(self) -> ReadOnlySpan_1[str]: ...
...
class ExtensionMarkerAttribute(Attribute):
...
class InlineArray10_GenericClasses(abc.ABCMeta):
    Generic_InlineArray10_GenericClasses_InlineArray10_1_T = typing.TypeVar('Generic_InlineArray10_GenericClasses_InlineArray10_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray10_GenericClasses_InlineArray10_1_T]) -> typing.Type[InlineArray10_1[Generic_InlineArray10_GenericClasses_InlineArray10_1_T]]: ...

InlineArray10 : InlineArray10_GenericClasses

InlineArray10_1_T = typing.TypeVar('InlineArray10_1_T')
class InlineArray10_1(typing.Generic[InlineArray10_1_T]):
    pass


class InlineArray11_GenericClasses(abc.ABCMeta):
    Generic_InlineArray11_GenericClasses_InlineArray11_1_T = typing.TypeVar('Generic_InlineArray11_GenericClasses_InlineArray11_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray11_GenericClasses_InlineArray11_1_T]) -> typing.Type[InlineArray11_1[Generic_InlineArray11_GenericClasses_InlineArray11_1_T]]: ...

InlineArray11 : InlineArray11_GenericClasses

InlineArray11_1_T = typing.TypeVar('InlineArray11_1_T')
class InlineArray11_1(typing.Generic[InlineArray11_1_T]):
    pass


class InlineArray12_GenericClasses(abc.ABCMeta):
    Generic_InlineArray12_GenericClasses_InlineArray12_1_T = typing.TypeVar('Generic_InlineArray12_GenericClasses_InlineArray12_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray12_GenericClasses_InlineArray12_1_T]) -> typing.Type[InlineArray12_1[Generic_InlineArray12_GenericClasses_InlineArray12_1_T]]: ...

InlineArray12 : InlineArray12_GenericClasses

InlineArray12_1_T = typing.TypeVar('InlineArray12_1_T')
class InlineArray12_1(typing.Generic[InlineArray12_1_T]):
    pass


class InlineArray13_GenericClasses(abc.ABCMeta):
    Generic_InlineArray13_GenericClasses_InlineArray13_1_T = typing.TypeVar('Generic_InlineArray13_GenericClasses_InlineArray13_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray13_GenericClasses_InlineArray13_1_T]) -> typing.Type[InlineArray13_1[Generic_InlineArray13_GenericClasses_InlineArray13_1_T]]: ...

InlineArray13 : InlineArray13_GenericClasses

InlineArray13_1_T = typing.TypeVar('InlineArray13_1_T')
class InlineArray13_1(typing.Generic[InlineArray13_1_T]):
    pass


class InlineArray14_GenericClasses(abc.ABCMeta):
    Generic_InlineArray14_GenericClasses_InlineArray14_1_T = typing.TypeVar('Generic_InlineArray14_GenericClasses_InlineArray14_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray14_GenericClasses_InlineArray14_1_T]) -> typing.Type[InlineArray14_1[Generic_InlineArray14_GenericClasses_InlineArray14_1_T]]: ...

InlineArray14 : InlineArray14_GenericClasses

InlineArray14_1_T = typing.TypeVar('InlineArray14_1_T')
class InlineArray14_1(typing.Generic[InlineArray14_1_T]):
    pass


class InlineArray15_GenericClasses(abc.ABCMeta):
    Generic_InlineArray15_GenericClasses_InlineArray15_1_T = typing.TypeVar('Generic_InlineArray15_GenericClasses_InlineArray15_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray15_GenericClasses_InlineArray15_1_T]) -> typing.Type[InlineArray15_1[Generic_InlineArray15_GenericClasses_InlineArray15_1_T]]: ...

InlineArray15 : InlineArray15_GenericClasses

InlineArray15_1_T = typing.TypeVar('InlineArray15_1_T')
class InlineArray15_1(typing.Generic[InlineArray15_1_T]):
    pass


class InlineArray16_GenericClasses(abc.ABCMeta):
    Generic_InlineArray16_GenericClasses_InlineArray16_1_T = typing.TypeVar('Generic_InlineArray16_GenericClasses_InlineArray16_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray16_GenericClasses_InlineArray16_1_T]) -> typing.Type[InlineArray16_1[Generic_InlineArray16_GenericClasses_InlineArray16_1_T]]: ...

InlineArray16 : InlineArray16_GenericClasses

InlineArray16_1_T = typing.TypeVar('InlineArray16_1_T')
class InlineArray16_1(typing.Generic[InlineArray16_1_T]):
    pass


class InlineArray2_GenericClasses(abc.ABCMeta):
    Generic_InlineArray2_GenericClasses_InlineArray2_1_T = typing.TypeVar('Generic_InlineArray2_GenericClasses_InlineArray2_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray2_GenericClasses_InlineArray2_1_T]) -> typing.Type[InlineArray2_1[Generic_InlineArray2_GenericClasses_InlineArray2_1_T]]: ...

InlineArray2 : InlineArray2_GenericClasses

InlineArray2_1_T = typing.TypeVar('InlineArray2_1_T')
class InlineArray2_1(typing.Generic[InlineArray2_1_T]):
    pass


class InlineArray3_GenericClasses(abc.ABCMeta):
    Generic_InlineArray3_GenericClasses_InlineArray3_1_T = typing.TypeVar('Generic_InlineArray3_GenericClasses_InlineArray3_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray3_GenericClasses_InlineArray3_1_T]) -> typing.Type[InlineArray3_1[Generic_InlineArray3_GenericClasses_InlineArray3_1_T]]: ...

InlineArray3 : InlineArray3_GenericClasses

InlineArray3_1_T = typing.TypeVar('InlineArray3_1_T')
class InlineArray3_1(typing.Generic[InlineArray3_1_T]):
    pass


class InlineArray4_GenericClasses(abc.ABCMeta):
    Generic_InlineArray4_GenericClasses_InlineArray4_1_T = typing.TypeVar('Generic_InlineArray4_GenericClasses_InlineArray4_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray4_GenericClasses_InlineArray4_1_T]) -> typing.Type[InlineArray4_1[Generic_InlineArray4_GenericClasses_InlineArray4_1_T]]: ...

InlineArray4 : InlineArray4_GenericClasses

InlineArray4_1_T = typing.TypeVar('InlineArray4_1_T')
class InlineArray4_1(typing.Generic[InlineArray4_1_T]):
    pass


class InlineArray5_GenericClasses(abc.ABCMeta):
    Generic_InlineArray5_GenericClasses_InlineArray5_1_T = typing.TypeVar('Generic_InlineArray5_GenericClasses_InlineArray5_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray5_GenericClasses_InlineArray5_1_T]) -> typing.Type[InlineArray5_1[Generic_InlineArray5_GenericClasses_InlineArray5_1_T]]: ...

InlineArray5 : InlineArray5_GenericClasses

InlineArray5_1_T = typing.TypeVar('InlineArray5_1_T')
class InlineArray5_1(typing.Generic[InlineArray5_1_T]):
    pass


class InlineArray6_GenericClasses(abc.ABCMeta):
    Generic_InlineArray6_GenericClasses_InlineArray6_1_T = typing.TypeVar('Generic_InlineArray6_GenericClasses_InlineArray6_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray6_GenericClasses_InlineArray6_1_T]) -> typing.Type[InlineArray6_1[Generic_InlineArray6_GenericClasses_InlineArray6_1_T]]: ...

InlineArray6 : InlineArray6_GenericClasses

InlineArray6_1_T = typing.TypeVar('InlineArray6_1_T')
class InlineArray6_1(typing.Generic[InlineArray6_1_T]):
    pass


class InlineArray7_GenericClasses(abc.ABCMeta):
    Generic_InlineArray7_GenericClasses_InlineArray7_1_T = typing.TypeVar('Generic_InlineArray7_GenericClasses_InlineArray7_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray7_GenericClasses_InlineArray7_1_T]) -> typing.Type[InlineArray7_1[Generic_InlineArray7_GenericClasses_InlineArray7_1_T]]: ...

InlineArray7 : InlineArray7_GenericClasses

InlineArray7_1_T = typing.TypeVar('InlineArray7_1_T')
class InlineArray7_1(typing.Generic[InlineArray7_1_T]):
    pass


class InlineArray8_GenericClasses(abc.ABCMeta):
    Generic_InlineArray8_GenericClasses_InlineArray8_1_T = typing.TypeVar('Generic_InlineArray8_GenericClasses_InlineArray8_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray8_GenericClasses_InlineArray8_1_T]) -> typing.Type[InlineArray8_1[Generic_InlineArray8_GenericClasses_InlineArray8_1_T]]: ...

InlineArray8 : InlineArray8_GenericClasses

InlineArray8_1_T = typing.TypeVar('InlineArray8_1_T')
class InlineArray8_1(typing.Generic[InlineArray8_1_T]):
    pass


class InlineArray9_GenericClasses(abc.ABCMeta):
    Generic_InlineArray9_GenericClasses_InlineArray9_1_T = typing.TypeVar('Generic_InlineArray9_GenericClasses_InlineArray9_1_T')
    def __getitem__(self, types : typing.Type[Generic_InlineArray9_GenericClasses_InlineArray9_1_T]) -> typing.Type[InlineArray9_1[Generic_InlineArray9_GenericClasses_InlineArray9_1_T]]: ...

InlineArray9 : InlineArray9_GenericClasses

InlineArray9_1_T = typing.TypeVar('InlineArray9_1_T')
class InlineArray9_1(typing.Generic[InlineArray9_1_T]):
    pass
...
class MetadataUpdateDeletedAttribute(Attribute):
    def __init__(self) -> None: ...
    @property
    def TypeId(self) -> typing.Any: ...
...
class OverloadResolutionPriorityAttribute(Attribute):
...
class ParamCollectionAttribute(Attribute):
    def __init__(self) -> None: ...
    @property
    def TypeId(self) -> typing.Any: ...
...
class RuntimeHelpers(abc.ABC):
    ...
    @staticmethod
    def Box(target: clr.Reference[int], type: RuntimeTypeHandle) -> typing.Any: ...
    @staticmethod
    ...
    @staticmethod
    def SizeOf(type: RuntimeTypeHandle) -> int: ...
    @staticmethod
...
class Unsafe(abc.ABC):
    ...
    # Skipped IsAddressGreaterThanOrEqualTo due to it being static, abstract and generic.

    IsAddressGreaterThanOrEqualTo : IsAddressGreaterThanOrEqualTo_MethodGroup
    class IsAddressGreaterThanOrEqualTo_MethodGroup:
        def __getitem__(self, t:typing.Type[IsAddressGreaterThanOrEqualTo_1_T1]) -> IsAddressGreaterThanOrEqualTo_1[IsAddressGreaterThanOrEqualTo_1_T1]: ...

        IsAddressGreaterThanOrEqualTo_1_T1 = typing.TypeVar('IsAddressGreaterThanOrEqualTo_1_T1')
        class IsAddressGreaterThanOrEqualTo_1(typing.Generic[IsAddressGreaterThanOrEqualTo_1_T1]):
            IsAddressGreaterThanOrEqualTo_1_T = Unsafe.IsAddressGreaterThanOrEqualTo_MethodGroup.IsAddressGreaterThanOrEqualTo_1_T1
            def __call__(self, left: clr.Reference[IsAddressGreaterThanOrEqualTo_1_T], right: clr.Reference[IsAddressGreaterThanOrEqualTo_1_T]) -> bool:...
    ...
    # Skipped IsAddressLessThanOrEqualTo due to it being static, abstract and generic.

    IsAddressLessThanOrEqualTo : IsAddressLessThanOrEqualTo_MethodGroup
    class IsAddressLessThanOrEqualTo_MethodGroup:
        def __getitem__(self, t:typing.Type[IsAddressLessThanOrEqualTo_1_T1]) -> IsAddressLessThanOrEqualTo_1[IsAddressLessThanOrEqualTo_1_T1]: ...

        IsAddressLessThanOrEqualTo_1_T1 = typing.TypeVar('IsAddressLessThanOrEqualTo_1_T1')
        class IsAddressLessThanOrEqualTo_1(typing.Generic[IsAddressLessThanOrEqualTo_1_T1]):
            IsAddressLessThanOrEqualTo_1_T = Unsafe.IsAddressLessThanOrEqualTo_MethodGroup.IsAddressLessThanOrEqualTo_1_T1
            def __call__(self, left: clr.Reference[IsAddressLessThanOrEqualTo_1_T], right: clr.Reference[IsAddressLessThanOrEqualTo_1_T]) -> bool:...
...
class UnsafeAccessorTypeAttribute(Attribute):
