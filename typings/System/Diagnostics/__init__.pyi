...
from System import Attribute, Array_1, ReadOnlySpan_1, Exception, Delegate, TimeSpan
...
class Debugger(abc.ABC):
    ...
    def Break() -> None: ...
    @staticmethod
    def BreakForUserUnhandledException(exception: Exception) -> None: ...
    @staticmethod
    def IsLogging() -> bool: ...
    @staticmethod
    def Launch() -> bool: ...
...
class DebuggerDisableUserUnhandledExceptionsAttribute(Attribute):
...
class DiagnosticMethodInfo:
    @property
    def DeclaringAssemblyName(self) -> str: ...
    @property
    def DeclaringTypeName(self) -> str: ...
    @property
    def Name(self) -> str: ...
    ...
    class Create_MethodGroup:
        @typing.overload
        def __call__(self, delegate: Delegate) -> DiagnosticMethodInfo:...
        @typing.overload
        def __call__(self, frame: StackFrame) -> DiagnosticMethodInfo:...
