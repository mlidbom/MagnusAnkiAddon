...
class DynamicallyAccessedMemberTypes(typing.SupportsInt):
    ...
    NonPublicConstructorsWithInherited : DynamicallyAccessedMemberTypes # 16388
    NonPublicMethodsWithInherited : DynamicallyAccessedMemberTypes # 32784
    AllMethods : DynamicallyAccessedMemberTypes # 32792
    NonPublicFieldsWithInherited : DynamicallyAccessedMemberTypes # 65600
    AllFields : DynamicallyAccessedMemberTypes # 65632
    NonPublicNestedTypesWithInherited : DynamicallyAccessedMemberTypes # 131328
    NonPublicPropertiesWithInherited : DynamicallyAccessedMemberTypes # 263168
    AllProperties : DynamicallyAccessedMemberTypes # 263680
    NonPublicEventsWithInherited : DynamicallyAccessedMemberTypes # 528384
    AllEvents : DynamicallyAccessedMemberTypes # 530432
    PublicConstructorsWithInherited : DynamicallyAccessedMemberTypes # 1048579
    AllConstructors : DynamicallyAccessedMemberTypes # 1064967
    PublicNestedTypesWithInherited : DynamicallyAccessedMemberTypes # 2097280
    AllNestedTypes : DynamicallyAccessedMemberTypes # 2228608
...
class FeatureGuardAttribute(Attribute):
    def __init__(self, featureType: typing.Type[typing.Any]) -> None: ...
    @property
    def FeatureType(self) -> typing.Type[typing.Any]: ...
    @property
    def TypeId(self) -> typing.Any: ...
...
class RequiresDynamicCodeAttribute(Attribute):
    def __init__(self, message: str) -> None: ...
    @property
    def ExcludeStatics(self) -> bool: ...
    @ExcludeStatics.setter
    def ExcludeStatics(self, value: bool) -> bool: ...
    @property
    def Message(self) -> str: ...
    @property
    def TypeId(self) -> typing.Any: ...
