...
from System import ICloneable, Array_1, DateTime, DayOfWeek, ReadOnlySpan_1, Span_1, IFormatProvider, ArgumentException, Exception, TimeSpan, StringComparer, DateOnly, IEquatable_1, Guid
...
class CompareOptions(typing.SupportsInt):
    ...
    NumericOrdering : CompareOptions # 32
...
class ISOWeek(abc.ABC):
    ...
    @staticmethod
    def ToDateOnly(year: int, week: int, dayOfWeek: DayOfWeek) -> DateOnly: ...
    @staticmethod
    def ToDateTime(year: int, week: int, dayOfWeek: DayOfWeek) -> DateTime: ...
    # Skipped GetWeekOfYear due to it being static, abstract and generic.

    GetWeekOfYear : GetWeekOfYear_MethodGroup
    class GetWeekOfYear_MethodGroup:
        @typing.overload
        def __call__(self, date: DateTime) -> int:...
        @typing.overload
        def __call__(self, date: DateOnly) -> int:...

    # Skipped GetYear due to it being static, abstract and generic.

    GetYear : GetYear_MethodGroup
    class GetYear_MethodGroup:
        @typing.overload
        def __call__(self, date: DateTime) -> int:...
        @typing.overload
        def __call__(self, date: DateOnly) -> int:...
