...
from System import ReadOnlySpan_1, Span_1, Range, Array_1, ArgumentException, Exception, ICloneable, ISpanFormattable, IUtf8SpanParsable_1, IUtf8SpanFormattable, IEquatable_1, IComparable_1, IComparable, Decimal, ReadOnlyMemory_1, IFormatProvider
...
class Rune(ISpanFormattable, IUtf8SpanParsable_1[Rune], IUtf8SpanFormattable, IEquatable_1[Rune], IComparable_1[Rune], IComparable_0):
...
class SpanLineEnumerator(IEnumerator_1[ReadOnlySpan_1[str]]):
    @property
...
class SpanRuneEnumerator(IEnumerator_1[Rune]):
    @property
...
class StringBuilder(ISerializable):
    ...
    class AppendFormat_MethodGroup:
        ...
        @typing.overload
        def __call__(self, format: str, args: ReadOnlySpan_1[typing.Any]) -> StringBuilder:...
        @typing.overload
        ...
        @typing.overload
        def __call__(self, provider: IFormatProvider, format: str, args: ReadOnlySpan_1[typing.Any]) -> StringBuilder:...
        @typing.overload
    ...
    class AppendJoin_MethodGroup:
        ...
        @typing.overload
        def __call__(self, separator: str, values: ReadOnlySpan_1[str]) -> StringBuilder:...
        # Method AppendJoin(separator : Char, values : ReadOnlySpan`1) was skipped since it collides with above method
        @typing.overload
        def __call__(self, separator: str, values: ReadOnlySpan_1[typing.Any]) -> StringBuilder:...
        # Method AppendJoin(separator : Char, values : ReadOnlySpan`1) was skipped since it collides with above method
    ...
    class Replace_MethodGroup:
        ...
        @typing.overload
        def __call__(self, oldValue: ReadOnlySpan_1[str], newValue: ReadOnlySpan_1[str]) -> StringBuilder:...
        ...
        @typing.overload
        def __call__(self, oldValue: ReadOnlySpan_1[str], newValue: ReadOnlySpan_1[str], startIndex: int, count: int) -> StringBuilder:...
